var Wn=Object.defineProperty;var Yn=(i,t,e)=>t in i?Wn(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var rt=(i,t,e)=>(Yn(i,typeof t!="symbol"?t+"":t,e),e);import{i as $,r as k,n as d,a as It}from"./state-VyZkHw6A.js";import{B as qt,x as f,E as Qn}from"./lit-html-CuBe1DX_.js";import{e as kt,n as Et}from"./ref-DfidMTJ6.js";const Pt=Math.min,K=Math.max,oe=Math.round,ot=i=>({x:i,y:i}),Un={left:"right",right:"left",bottom:"top",top:"bottom"},Gn={start:"end",end:"start"};function $i(i,t,e){return K(i,Pt(t,e))}function Ut(i,t){return typeof i=="function"?i(t):i}function J(i){return i.split("-")[0]}function ye(i){return i.split("-")[1]}function Ki(i){return i==="x"?"y":"x"}function Ji(i){return i==="y"?"height":"width"}function xt(i){return["top","bottom"].includes(J(i))?"y":"x"}function Zi(i){return Ki(xt(i))}function Xn(i,t,e){e===void 0&&(e=!1);const s=ye(i),n=Zi(i),r=Ji(n);let o=n==="x"?s===(e?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(o=ae(o)),[o,ae(o)]}function Kn(i){const t=ae(i);return[Ie(i),t,Ie(t)]}function Ie(i){return i.replace(/start|end/g,t=>Gn[t])}function Jn(i,t,e){const s=["left","right"],n=["right","left"],r=["top","bottom"],o=["bottom","top"];switch(i){case"top":case"bottom":return e?t?n:s:t?s:n;case"left":case"right":return t?r:o;default:return[]}}function Zn(i,t,e,s){const n=ye(i);let r=Jn(J(i),e==="start",s);return n&&(r=r.map(o=>o+"-"+n),t&&(r=r.concat(r.map(Ie)))),r}function ae(i){return i.replace(/left|right|bottom|top/g,t=>Un[t])}function ts(i){return{top:0,right:0,bottom:0,left:0,...i}}function tn(i){return typeof i!="number"?ts(i):{top:i,right:i,bottom:i,left:i}}function At(i){const{x:t,y:e,width:s,height:n}=i;return{width:s,height:n,top:e,left:t,right:t+s,bottom:e+n,x:t,y:e}}function ki(i,t,e){let{reference:s,floating:n}=i;const r=xt(t),o=Zi(t),a=Ji(o),l=J(t),c=r==="y",u=s.x+s.width/2-n.width/2,h=s.y+s.height/2-n.height/2,p=s[a]/2-n[a]/2;let b;switch(l){case"top":b={x:u,y:s.y-n.height};break;case"bottom":b={x:u,y:s.y+s.height};break;case"right":b={x:s.x+s.width,y:h};break;case"left":b={x:s.x-n.width,y:h};break;default:b={x:s.x,y:s.y}}switch(ye(t)){case"start":b[o]-=p*(e&&c?-1:1);break;case"end":b[o]+=p*(e&&c?-1:1);break}return b}const es=async(i,t,e)=>{const{placement:s="bottom",strategy:n="absolute",middleware:r=[],platform:o}=e,a=r.filter(Boolean),l=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:i,floating:t,strategy:n}),{x:u,y:h}=ki(c,s,l),p=s,b={},g=0;for(let v=0;v<a.length;v++){const{name:m,fn:y}=a[v],{x:C,y:w,data:S,reset:P}=await y({x:u,y:h,initialPlacement:s,placement:p,strategy:n,middlewareData:b,rects:c,platform:o,elements:{reference:i,floating:t}});u=C??u,h=w??h,b={...b,[m]:{...b[m],...S}},P&&g<=50&&(g++,typeof P=="object"&&(P.placement&&(p=P.placement),P.rects&&(c=P.rects===!0?await o.getElementRects({reference:i,floating:t,strategy:n}):P.rects),{x:u,y:h}=ki(c,p,l)),v=-1)}return{x:u,y:h,placement:p,strategy:n,middlewareData:b}};async function en(i,t){var e;t===void 0&&(t={});const{x:s,y:n,platform:r,rects:o,elements:a,strategy:l}=i,{boundary:c="clippingAncestors",rootBoundary:u="viewport",elementContext:h="floating",altBoundary:p=!1,padding:b=0}=Ut(t,i),g=tn(b),m=a[p?h==="floating"?"reference":"floating":h],y=At(await r.getClippingRect({element:(e=await(r.isElement==null?void 0:r.isElement(m)))==null||e?m:m.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:u,strategy:l})),C=h==="floating"?{x:s,y:n,width:o.floating.width,height:o.floating.height}:o.reference,w=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),S=await(r.isElement==null?void 0:r.isElement(w))?await(r.getScale==null?void 0:r.getScale(w))||{x:1,y:1}:{x:1,y:1},P=At(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:C,offsetParent:w,strategy:l}):C);return{top:(y.top-P.top+g.top)/S.y,bottom:(P.bottom-y.bottom+g.bottom)/S.y,left:(y.left-P.left+g.left)/S.x,right:(P.right-y.right+g.right)/S.x}}const is=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(t){var e,s;const{placement:n,middlewareData:r,rects:o,initialPlacement:a,platform:l,elements:c}=t,{mainAxis:u=!0,crossAxis:h=!0,fallbackPlacements:p,fallbackStrategy:b="bestFit",fallbackAxisSideDirection:g="none",flipAlignment:v=!0,...m}=Ut(i,t);if((e=r.arrow)!=null&&e.alignmentOffset)return{};const y=J(n),C=xt(a),w=J(a)===a,S=await(l.isRTL==null?void 0:l.isRTL(c.floating)),P=p||(w||!v?[ae(a)]:Kn(a)),_=g!=="none";!p&&_&&P.push(...Zn(a,v,g,S));const T=[a,...P],H=await en(t,m),M=[];let E=((s=r.flip)==null?void 0:s.overflows)||[];if(u&&M.push(H[y]),h){const Y=Xn(n,o,S);M.push(H[Y[0]],H[Y[1]])}if(E=[...E,{placement:n,overflows:M}],!M.every(Y=>Y<=0)){var _t,Ft;const Y=(((_t=r.flip)==null?void 0:_t.index)||0)+1,St=T[Y];if(St)return{data:{index:Y,overflows:E},reset:{placement:St}};let it=(Ft=E.filter(nt=>nt.overflows[0]<=0).sort((nt,Q)=>nt.overflows[1]-Q.overflows[1])[0])==null?void 0:Ft.placement;if(!it)switch(b){case"bestFit":{var Ct;const nt=(Ct=E.filter(Q=>{if(_){const st=xt(Q.placement);return st===C||st==="y"}return!0}).map(Q=>[Q.placement,Q.overflows.filter(st=>st>0).reduce((st,Vn)=>st+Vn,0)]).sort((Q,st)=>Q[1]-st[1])[0])==null?void 0:Ct[0];nt&&(it=nt);break}case"initialPlacement":it=a;break}if(n!==it)return{reset:{placement:it}}}return{}}}};function nn(i){const t=Pt(...i.map(r=>r.left)),e=Pt(...i.map(r=>r.top)),s=K(...i.map(r=>r.right)),n=K(...i.map(r=>r.bottom));return{x:t,y:e,width:s-t,height:n-e}}function ns(i){const t=i.slice().sort((n,r)=>n.y-r.y),e=[];let s=null;for(let n=0;n<t.length;n++){const r=t[n];!s||r.y-s.y>s.height/2?e.push([r]):e[e.length-1].push(r),s=r}return e.map(n=>At(nn(n)))}const ss=function(i){return i===void 0&&(i={}),{name:"inline",options:i,async fn(t){const{placement:e,elements:s,rects:n,platform:r,strategy:o}=t,{padding:a=2,x:l,y:c}=Ut(i,t),u=Array.from(await(r.getClientRects==null?void 0:r.getClientRects(s.reference))||[]),h=ns(u),p=At(nn(u)),b=tn(a);function g(){if(h.length===2&&h[0].left>h[1].right&&l!=null&&c!=null)return h.find(m=>l>m.left-b.left&&l<m.right+b.right&&c>m.top-b.top&&c<m.bottom+b.bottom)||p;if(h.length>=2){if(xt(e)==="y"){const E=h[0],_t=h[h.length-1],Ft=J(e)==="top",Ct=E.top,Y=_t.bottom,St=Ft?E.left:_t.left,it=Ft?E.right:_t.right,nt=it-St,Q=Y-Ct;return{top:Ct,bottom:Y,left:St,right:it,width:nt,height:Q,x:St,y:Ct}}const m=J(e)==="left",y=K(...h.map(E=>E.right)),C=Pt(...h.map(E=>E.left)),w=h.filter(E=>m?E.left===C:E.right===y),S=w[0].top,P=w[w.length-1].bottom,_=C,T=y,H=T-_,M=P-S;return{top:S,bottom:P,left:_,right:T,width:H,height:M,x:_,y:S}}return p}const v=await r.getElementRects({reference:{getBoundingClientRect:g},floating:s.floating,strategy:o});return n.reference.x!==v.reference.x||n.reference.y!==v.reference.y||n.reference.width!==v.reference.width||n.reference.height!==v.reference.height?{reset:{rects:v}}:{}}}};async function rs(i,t){const{placement:e,platform:s,elements:n}=i,r=await(s.isRTL==null?void 0:s.isRTL(n.floating)),o=J(e),a=ye(e),l=xt(e)==="y",c=["left","top"].includes(o)?-1:1,u=r&&l?-1:1,h=Ut(t,i);let{mainAxis:p,crossAxis:b,alignmentAxis:g}=typeof h=="number"?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:h.mainAxis||0,crossAxis:h.crossAxis||0,alignmentAxis:h.alignmentAxis};return a&&typeof g=="number"&&(b=a==="end"?g*-1:g),l?{x:b*u,y:p*c}:{x:p*c,y:b*u}}const sn=function(i){return{name:"offset",options:i,async fn(t){var e,s;const{x:n,y:r,placement:o,middlewareData:a}=t,l=await rs(t,i);return o===((e=a.offset)==null?void 0:e.placement)&&(s=a.arrow)!=null&&s.alignmentOffset?{}:{x:n+l.x,y:r+l.y,data:{...l,placement:o}}}}},os=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(t){const{x:e,y:s,placement:n}=t,{mainAxis:r=!0,crossAxis:o=!1,limiter:a={fn:m=>{let{x:y,y:C}=m;return{x:y,y:C}}},...l}=Ut(i,t),c={x:e,y:s},u=await en(t,l),h=xt(J(n)),p=Ki(h);let b=c[p],g=c[h];if(r){const m=p==="y"?"top":"left",y=p==="y"?"bottom":"right",C=b+u[m],w=b-u[y];b=$i(C,b,w)}if(o){const m=h==="y"?"top":"left",y=h==="y"?"bottom":"right",C=g+u[m],w=g-u[y];g=$i(C,g,w)}const v=a.fn({...t,[p]:b,[h]:g});return{...v,data:{x:v.x-e,y:v.y-s,enabled:{[p]:r,[h]:o}}}}}};function xe(){return typeof window<"u"}function at(i){return rn(i)?(i.nodeName||"").toLowerCase():"#document"}function R(i){var t;return(i==null||(t=i.ownerDocument)==null?void 0:t.defaultView)||window}function ft(i){var t;return(t=(rn(i)?i.ownerDocument:i.document)||window.document)==null?void 0:t.documentElement}function rn(i){return xe()?i instanceof Node||i instanceof R(i).Node:!1}function U(i){return xe()?i instanceof Element||i instanceof R(i).Element:!1}function G(i){return xe()?i instanceof HTMLElement||i instanceof R(i).HTMLElement:!1}function Ei(i){return!xe()||typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof R(i).ShadowRoot}function Gt(i){const{overflow:t,overflowX:e,overflowY:s,display:n}=B(i);return/auto|scroll|overlay|hidden|clip/.test(t+s+e)&&!["inline","contents"].includes(n)}function as(i){return["table","td","th"].includes(at(i))}function ls(i){return[":popover-open",":modal"].some(t=>{try{return i.matches(t)}catch{return!1}})}function Ye(i){const t=Qe(),e=U(i)?B(i):i;return["transform","translate","scale","rotate","perspective"].some(s=>e[s]?e[s]!=="none":!1)||(e.containerType?e.containerType!=="normal":!1)||!t&&(e.backdropFilter?e.backdropFilter!=="none":!1)||!t&&(e.filter?e.filter!=="none":!1)||["transform","translate","scale","rotate","perspective","filter"].some(s=>(e.willChange||"").includes(s))||["paint","layout","strict","content"].some(s=>(e.contain||"").includes(s))}function cs(i){let t=Ot(i);for(;G(t)&&!we(t);){if(Ye(t))return t;if(ls(t))return null;t=Ot(t)}return null}function Qe(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function we(i){return["html","body","#document"].includes(at(i))}function B(i){return R(i).getComputedStyle(i)}function _e(i){return U(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function Ot(i){if(at(i)==="html")return i;const t=i.assignedSlot||i.parentNode||Ei(i)&&i.host||ft(i);return Ei(t)?t.host:t}function on(i){const t=Ot(i);return we(t)?i.ownerDocument?i.ownerDocument.body:i.body:G(t)&&Gt(t)?t:on(t)}function an(i,t,e){var s;t===void 0&&(t=[]);const n=on(i),r=n===((s=i.ownerDocument)==null?void 0:s.body),o=R(n);return r?(us(o),t.concat(o,o.visualViewport||[],Gt(n)?n:[],[])):t.concat(n,an(n,[]))}function us(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function ln(i){const t=B(i);let e=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const n=G(i),r=n?i.offsetWidth:e,o=n?i.offsetHeight:s,a=oe(e)!==r||oe(s)!==o;return a&&(e=r,s=o),{width:e,height:s,$:a}}function cn(i){return U(i)?i:i.contextElement}function $t(i){const t=cn(i);if(!G(t))return ot(1);const e=t.getBoundingClientRect(),{width:s,height:n,$:r}=ln(t);let o=(r?oe(e.width):e.width)/s,a=(r?oe(e.height):e.height)/n;return(!o||!Number.isFinite(o))&&(o=1),(!a||!Number.isFinite(a))&&(a=1),{x:o,y:a}}const ds=ot(0);function un(i){const t=R(i);return!Qe()||!t.visualViewport?ds:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function hs(i,t,e){return t===void 0&&(t=!1),!e||t&&e!==R(i)?!1:t}function Nt(i,t,e,s){t===void 0&&(t=!1),e===void 0&&(e=!1);const n=i.getBoundingClientRect(),r=cn(i);let o=ot(1);t&&(s?U(s)&&(o=$t(s)):o=$t(i));const a=hs(r,e,s)?un(r):ot(0);let l=(n.left+a.x)/o.x,c=(n.top+a.y)/o.y,u=n.width/o.x,h=n.height/o.y;if(r){const p=R(r),b=s&&U(s)?R(s):s;let g=p,v=g.frameElement;for(;v&&s&&b!==g;){const m=$t(v),y=v.getBoundingClientRect(),C=B(v),w=y.left+(v.clientLeft+parseFloat(C.paddingLeft))*m.x,S=y.top+(v.clientTop+parseFloat(C.paddingTop))*m.y;l*=m.x,c*=m.y,u*=m.x,h*=m.y,l+=w,c+=S,g=R(v),v=g.frameElement}}return At({width:u,height:h,x:l,y:c})}const ps=[":popover-open",":modal"];function dn(i){return ps.some(t=>{try{return i.matches(t)}catch{return!1}})}function fs(i){let{elements:t,rect:e,offsetParent:s,strategy:n}=i;const r=n==="fixed",o=ft(s),a=t?dn(t.floating):!1;if(s===o||a&&r)return e;let l={scrollLeft:0,scrollTop:0},c=ot(1);const u=ot(0),h=G(s);if((h||!h&&!r)&&((at(s)!=="body"||Gt(o))&&(l=_e(s)),G(s))){const p=Nt(s);c=$t(s),u.x=p.x+s.clientLeft,u.y=p.y+s.clientTop}return{width:e.width*c.x,height:e.height*c.y,x:e.x*c.x-l.scrollLeft*c.x+u.x,y:e.y*c.y-l.scrollTop*c.y+u.y}}function ms(i){return Array.from(i.getClientRects())}function hn(i){return Nt(ft(i)).left+_e(i).scrollLeft}function bs(i){const t=ft(i),e=_e(i),s=i.ownerDocument.body,n=K(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),r=K(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let o=-e.scrollLeft+hn(i);const a=-e.scrollTop;return B(s).direction==="rtl"&&(o+=K(t.clientWidth,s.clientWidth)-n),{width:n,height:r,x:o,y:a}}function gs(i,t){const e=R(i),s=ft(i),n=e.visualViewport;let r=s.clientWidth,o=s.clientHeight,a=0,l=0;if(n){r=n.width,o=n.height;const c=Qe();(!c||c&&t==="fixed")&&(a=n.offsetLeft,l=n.offsetTop)}return{width:r,height:o,x:a,y:l}}function vs(i,t){const e=Nt(i,!0,t==="fixed"),s=e.top+i.clientTop,n=e.left+i.clientLeft,r=G(i)?$t(i):ot(1),o=i.clientWidth*r.x,a=i.clientHeight*r.y,l=n*r.x,c=s*r.y;return{width:o,height:a,x:l,y:c}}function Pi(i,t,e){let s;if(t==="viewport")s=gs(i,e);else if(t==="document")s=bs(ft(i));else if(U(t))s=vs(t,e);else{const n=un(i);s={...t,x:t.x-n.x,y:t.y-n.y}}return At(s)}function pn(i,t){const e=Ot(i);return e===t||!U(e)||we(e)?!1:B(e).position==="fixed"||pn(e,t)}function ys(i,t){const e=t.get(i);if(e)return e;let s=an(i,[]).filter(a=>U(a)&&at(a)!=="body"),n=null;const r=B(i).position==="fixed";let o=r?Ot(i):i;for(;U(o)&&!we(o);){const a=B(o),l=Ye(o);!l&&a.position==="fixed"&&(n=null),(r?!l&&!n:!l&&a.position==="static"&&!!n&&["absolute","fixed"].includes(n.position)||Gt(o)&&!l&&pn(i,o))?s=s.filter(u=>u!==o):n=a,o=Ot(o)}return t.set(i,s),s}function xs(i){let{element:t,boundary:e,rootBoundary:s,strategy:n}=i;const o=[...e==="clippingAncestors"?ys(t,this._c):[].concat(e),s],a=o[0],l=o.reduce((c,u)=>{const h=Pi(t,u,n);return c.top=K(h.top,c.top),c.right=Pt(h.right,c.right),c.bottom=Pt(h.bottom,c.bottom),c.left=K(h.left,c.left),c},Pi(t,a,n));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function ws(i){const{width:t,height:e}=ln(i);return{width:t,height:e}}function _s(i,t,e){const s=G(t),n=ft(t),r=e==="fixed",o=Nt(i,!0,r,t);let a={scrollLeft:0,scrollTop:0};const l=ot(0);if(s||!s&&!r)if((at(t)!=="body"||Gt(n))&&(a=_e(t)),s){const h=Nt(t,!0,r,t);l.x=h.x+t.clientLeft,l.y=h.y+t.clientTop}else n&&(l.x=hn(n));const c=o.left+a.scrollLeft-l.x,u=o.top+a.scrollTop-l.y;return{x:c,y:u,width:o.width,height:o.height}}function Ai(i,t){return!G(i)||B(i).position==="fixed"?null:t?t(i):i.offsetParent}function fn(i,t){const e=R(i);if(!G(i)||dn(i))return e;let s=Ai(i,t);for(;s&&as(s)&&B(s).position==="static";)s=Ai(s,t);return s&&(at(s)==="html"||at(s)==="body"&&B(s).position==="static"&&!Ye(s))?e:s||cs(i)||e}const Cs=async function(i){const t=this.getOffsetParent||fn,e=this.getDimensions;return{reference:_s(i.reference,await t(i.floating),i.strategy),floating:{x:0,y:0,...await e(i.floating)}}};function Ss(i){return B(i).direction==="rtl"}const $s={convertOffsetParentRelativeRectToViewportRelativeRect:fs,getDocumentElement:ft,getClippingRect:xs,getOffsetParent:fn,getElementRects:Cs,getClientRects:ms,getDimensions:ws,getScale:$t,isElement:U,isRTL:Ss},mn=os,bn=is,gn=ss,vn=(i,t,e)=>{const s=new Map,n={platform:$s,...e},r={...n.platform,_c:s};return es(i,t,{...n,platform:r})};/**
* (c) Iconify
*
...
`,mt={scrollbar:Ar,globalStyles:Or},x=class x{static set config(t){this._config={...x._config,...t}}static get config(){return x._config}static addGlobalStyles(){let t=document.querySelector("style[id='bim-ui']");if(t)return;t=document.createElement("style"),t.id="bim-ui",t.textContent=mt.globalStyles.cssText;const e=document.head.firstChild;e?document.head.insertBefore(t,e):document.head.append(t)}static defineCustomElement(t,e){customElements.get(t)||customElements.define(t,e)}static registerComponents(){x.init()}static init(t="",e=!0){x.addGlobalStyles(),x.defineCustomElement("bim-button",Fr),x.defineCustomElement("bim-checkbox",ct),x.defineCustomElement("bim-color-input",Z),x.defineCustomElement("bim-context-menu",Ve),x.defineCustomElement("bim-dropdown",q),x.defineCustomElement("bim-grid",Qt),x.defineCustomElement("bim-icon",We),x.defineCustomElement("bim-input",wt),x.defineCustomElement("bim-label",dt),x.defineCustomElement("bim-number-input",I),x.defineCustomElement("bim-option",O),x.defineCustomElement("bim-panel",N),x.defineCustomElement("bim-panel-section",ut),x.defineCustomElement("bim-selector",ht),x.defineCustomElement("bim-table",L),x.defineCustomElement("bim-tabs",X),x.defineCustomElement("bim-tab",z),x.defineCustomElement("bim-table-cell",fe),x.defineCustomElement("bim-table-children",me),x.defineCustomElement("bim-table-group",be),x.defineCustomElement("bim-table-row",tt),x.defineCustomElement("bim-text-input",j),x.defineCustomElement("bim-toolbar",zt),x.defineCustomElement("bim-toolbar-group",Tt),x.defineCustomElement("bim-toolbar-section",pt),x.defineCustomElement("bim-viewport",ge),e&&this.animateOnLoad(t)}static newRandomId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";let e="";for(let s=0;s<10;s++){const n=Math.floor(Math.random()*t.length);e+=t.charAt(n)}return e}static animateOnLoad(t=""){const e=`
      bim-input,
      bim-button,
      bim-checkbox,
      bim-selector,
  ...
  `,yt);V([d({type:String,reflect:!0})],F.prototype,"label",2);V([d({type:Boolean,attribute:"label-hidden",reflect:!0})],F.prototype,"labelHidden",2);V([d({type:Boolean,reflect:!0})],F.prototype,"active",2);V([d({type:Boolean,reflect:!0,attribute:"disabled"})],F.prototype,"disabled",2);V([d({type:String,reflect:!0})],F.prototype,"icon",2);V([d({type:Boolean,reflect:!0})],F.prototype,"vertical",2);V([d({type:Number,attribute:"tooltip-time",reflect:!0})],F.prototype,"tooltipTime",2);V([d({type:Boolean,attribute:"tooltip-visible",reflect:!0})],F.prototype,"tooltipVisible",2);V([d({type:String,attribute:"tooltip-title",reflect:!0})],F.prototype,"tooltipTitle",2);V([d({type:String,attribute:"tooltip-text",reflect:!0})],F.prototype,"tooltipText",2);V([d({type:Boolean,reflect:!0})],F.prototype,"loading",1);let Fr=F;var Dr=Object.defineProperty,Jt=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Dr(t,e,n),n};const ii=class ii extends k{constructor(){super(...arguments),this.checked=!1,this.inverted=!1,this.onValueChange=new Event("change")}get value(){return this.checked}onChange(t){t.stopPropagation(),this.checked=t.target.checked,this.dispatchEvent(this.onValueChange)}render(){const t=f`
  ...
  `;let Z=ni;Lt([d({type:String,reflect:!0})],Z.prototype,"name");Lt([d({type:String,reflect:!0})],Z.prototype,"label");Lt([d({type:String,reflect:!0})],Z.prototype,"icon");Lt([d({type:Boolean,reflect:!0})],Z.prototype,"vertical");Lt([d({type:Number,reflect:!0})],Z.prototype,"opacity");Lt([d({type:String,reflect:!0})],Z.prototype,"color");var Mr=Object.defineProperty,qr=Object.getOwnPropertyDescriptor,bt=(i,t,e,s)=>{for(var n=s>1?void 0:s?qr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Mr(t,e,n),n};const si=class si extends k{constructor(){super(...arguments),this.checked=!1,this.checkbox=!1,this.noMark=!1,this.vertical=!1}get value(){return this._value!==void 0?this._value:this.label?$e(this.label):this.label}set value(t){this._value=t}render(){return f`
  ...
  `;let O=si;bt([d({type:String,reflect:!0})],O.prototype,"img",2);bt([d({type:String,reflect:!0})],O.prototype,"label",2);bt([d({type:String,reflect:!0})],O.prototype,"icon",2);bt([d({type:Boolean,reflect:!0})],O.prototype,"checked",2);bt([d({type:Boolean,reflect:!0})],O.prototype,"checkbox",2);bt([d({type:Boolean,attribute:"no-mark",reflect:!0})],O.prototype,"noMark",2);bt([d({converter:{fromAttribute(i){return i&&$e(i)}}})],O.prototype,"value",1);bt([d({type:Boolean,reflect:!0})],O.prototype,"vertical",2);var Nr=Object.defineProperty,Vr=Object.getOwnPropertyDescriptor,gt=(i,t,e,s)=>{for(var n=s>1?void 0:s?Vr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Nr(t,e,n),n};const ri=class ri extends he{constructor(){super(),this.multiple=!1,this.required=!1,this.vertical=!1,this._visible=!1,this._value=new Set,this.onValueChange=new Event("change"),this._contextMenu=kt(),this.onOptionClick=t=>{const e=t.target,s=this._value.has(e);if(!this.multiple&&!this.required&&!s)this._value=new Set([e]);else if(!this.multiple&&!this.required&&s)this._value=new Set([]);else if(!this.multiple&&this.required&&!s)this._value=new Set([e]);else if(this.multiple&&!this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&!this.required&&s){const n=[...this._value].filter(r=>r!==e);this._value=new Set(n)}else if(this.multiple&&this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&this.required&&s){const n=[...this._value].filter(o=>o!==e),r=new Set(n);r.size!==0&&(this._value=r)}this.updateOptionsState(),this.dispatchEvent(this.onValueChange)},this.useObserver=!0}set visible(t){if(t){const{value:e}=this._contextMenu;if(!e)return;for(const s of this.elements)e.append(s);this._visible=!0}else{for(const e of this.elements)this.append(e);this._visible=!1,this.resetVisibleElements()}}get visible(){return this._visible}set value(t){if(this.required&&Object.keys(t).length===0)return;const e=new Set;for(const s of t){const n=this.findOption(s);if(n&&(e.add(n),!this.multiple&&Object.keys(t).length===1))break}this._value=e,this.updateOptionsState(),this.dispatchEvent(this.onValueChange)}get value(){return[...this._value].filter(e=>e instanceof O&&e.checked).map(e=>e.value)}get _options(){const t=new Set([...this.elements]);for(const e of this.children)e instanceof O&&t.add(e);return[...t]}onSlotChange(t){const e=t.target.assignedElements();this.observe(e);const s=new Set;for(const n of this.elements){if(!(n instanceof O)){n.remove();continue}n.checked&&s.add(n),n.removeEventListener("click",this.onOptionClick),n.addEventListener("click",this.onOptionClick)}this._value=s}updateOptionsState(){for(const t of this._options)t instanceof O&&(t.checked=this._value.has(t))}findOption(t){return this._options.find(s=>s instanceof O?s.label===t||s.value===t:!1)}render(){let t,e,s;if(this._value.size===0)t="Select an option...";else if(this._value.size===1){const n=[...this._value][0];t=(n==null?void 0:n.label)||(n==null?void 0:n.value),e=n==null?void 0:n.img,s=n==null?void 0:n.icon}else t=`Multiple (${this._value.size})`;return f`
    ...
    `];let q=ri;gt([d({type:String,reflect:!0})],q.prototype,"name",2);gt([d({type:String,reflect:!0})],q.prototype,"icon",2);gt([d({type:String,reflect:!0})],q.prototype,"label",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"multiple",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"required",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"vertical",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"visible",1);gt([It()],q.prototype,"_value",2);var Wr=Object.defineProperty,Yr=Object.getOwnPropertyDescriptor,Rt=(i,t,e,s)=>{for(var n=s>1?void 0:s?Yr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Wr(t,e,n),n};const oi=class oi extends k{constructor(){super(...arguments),this.onValueChange=new Event("change"),this._hidden=!1,this.headerHidden=!1,this.valueTransform={},this.activationButton=document.createElement("bim-button")}set hidden(t){this._hidden=t,this.activationButton.active=!t,this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}get value(){return pe(this,this.valueTransform)}set value(t){const e=[...this.children];for(const s in t){const n=e.find(o=>{const a=o;return a.name===s||a.label===s});if(!n)continue;const r=n;r.value=t[s]}}animatePanels(){const t=[{maxHeight:"100vh",maxWidth:"100vw",opacity:1},{maxHeight:"100vh",maxWidth:"100vw",opacity:0},{maxHeight:0,maxWidth:0,opacity:0}];this.animate(t,{duration:300,easing:"cubic-bezier(0.65, 0.05, 0.36, 1)",direction:this.hidden?"normal":"reverse"})}connectedCallback(){super.connectedCallback(),this.activationButton.active=!this.hidden,this.activationButton.onclick=()=>{this.hidden=!this.hidden,this.animatePanels()}}disconnectedCallback(){super.disconnectedCallback(),this.activationButton.remove()}collapseSections(){const t=this.querySelectorAll("bim-panel-section");for(const e of t)e.collapsed=!0}expandSections(){const t=this.querySelectorAll("bim-panel-section");for(const e of t)e.collapsed=!1}render(){this.activationButton.icon=this.icon,this.activationButton.label=this.label||this.name,this.activationButton.tooltipTitle=this.label||this.name;const t=f`<bim-button
      class="closing-btn"
      icon="material-symbols:cancel-rounded"
      @click=${()=>this.activationButton.click()}
    />`;return f`
      <div class="parent">
        ${this.floating?t:null}
        ${this.label||this.name||this.icon?f`<bim-label .icon=${this.icon}>${this.label}</bim-label>`:null}
        <div class="sections">
          <slot></slot>
        </div>
      </div>
    `}};oi.styles=[mt.scrollbar,$`
      :host {
        display: flex;
    ...
    `];let ut=ai;Zt([d({type:String,reflect:!0})],ut.prototype,"icon");Zt([d({type:String,reflect:!0})],ut.prototype,"label");Zt([d({type:String,reflect:!0})],ut.prototype,"name");Zt([d({type:Boolean,reflect:!0})],ut.prototype,"fixed");Zt([d({type:Boolean,reflect:!0})],ut.prototype,"collapsed");var Ur=Object.defineProperty,qn=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Ur(t,e,n),n};const li=class li extends k{constructor(){super(...arguments),this.floating=!1,this._layouts={},this._lastScreenType=ne(),this._updateFunctions={}}set layouts(t){this._layouts=t;const e={};for(const[s,n]of Object.entries(t))for(const r in n.elements)e[s]||(e[s]={}),e[s][r]=o=>{const a=this._updateFunctions[s];if(!a)return;const l=a[r];l&&l(o)};this.updateComponent=e}get layouts(){return this._layouts}getLayoutAreas(t){const{template:e}=t,r=e.split(`
`).map(a=>a.trim()).map(a=>a.split('"')[1]).filter(a=>a!==void 0).flatMap(a=>a.split(/\s+/));return[...new Set(r)].filter(a=>a!=="")}applyScreenRules(t){const e=this.layouts[this.layout];if(e)for(const[s,n]of Object.entries(t)){if(!(n instanceof N))continue;const r=ne(e.sizes||{});let o=!1,a=!1;e.mobileTemplate&&e.mobileTemplate.includes(s)&&(o=!0),e.tabletTemplate&&e.tabletTemplate.includes(s)&&(a=!0),r==="mobile"?this.hidePanel(n,o):r==="tablet"?this.hidePanel(n,a):this.hidePanel(n,!0)}}hidePanel(t,e){t.hidden=!e,t.floating=!e}setCSSGridTemplate(){if(!this.layout)return;const t=this.layouts[this.layout];if(!t)return;const e=t.elements;(t.mobileTemplate||t.tabletTemplate)&&this.applyScreenRules(e);const s=ne(t.sizes);let n=t.template;s==="mobile"?n=t.mobileTemplate||t.tabletTemplate||t.template:s==="tablet"&&(n=t.tabletTemplate||t.template),this.style.setProperty("grid-template",n)}firstUpdated(){this._onLayoutChange=new Event("layoutchange"),new ResizeObserver(()=>{const e=this.layouts[this.layout],s=ne(e==null?void 0:e.sizes);this._lastScreenType!==s&&(this._lastScreenType=s,this.layouts={...this._layouts},this.setCSSGridTemplate())}).observe(this)}render(){if(this.layout){if(this._updateFunctions={},this.layouts[this.layout]){this.innerHTML="",this._updateFunctions[this.layout]={};const t=this._updateFunctions[this.layout],e=this.layouts[this.layout],n=this.getLayoutAreas(e).map(r=>{const o=e.elements[r];if(!o)return null;if(o instanceof HTMLElement)return o.style.gridArea=r,o;if("template"in o){const{template:l,initialState:c}=o,[u,h]=he.create(l,c);return u.style.gridArea=r,t[r]=h,u}return he.create(o)}).filter(r=>!!r);this.setCSSGridTemplate(),this.append(...n),this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange)}}else this._updateFunctions={},this.innerHTML="",this.style.gridTemplate="",this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange);return f`<slot></slot>`}};li.styles=$`
    :host {
      display: grid;
      height: 100%;
      width: 100%;
  ...
  `;let Qt=li;qn([d({type:Boolean,reflect:!0})],Qt.prototype,"floating");qn([d({type:String,reflect:!0})],Qt.prototype,"layout");const ve=class ve extends k{render(){return f`
  ...
  `;let wt=ci;ke([d({type:String,reflect:!0})],wt.prototype,"name");ke([d({type:String,reflect:!0})],wt.prototype,"label");ke([d({type:String,reflect:!0})],wt.prototype,"icon");ke([d({type:Boolean,reflect:!0})],wt.prototype,"vertical");var Xr=Object.defineProperty,te=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Xr(t,e,n),n};const ui=class ui extends k{constructor(){super(...arguments),this.labelHidden=!1,this.iconHidden=!1,this.vertical=!1}get value(){return this.textContent?$e(this.textContent):this.textContent}render(){return f`
...
`;o+=g,h&&(o+=this.generateText(t,c.children,`${s}${l+1}.`,!1))}return o}get csv(){return this.generateText("comma")}get tsv(){return this.generateText("tab")}applyDataTransform(t){const e={};for(const n of Object.keys(this.dataTransform)){const r=this.columns.find(o=>o.name===n);r&&r.forceDataTransform&&(n in t||(t[n]=""))}const s=t;for(const n in s){const r=this.dataTransform[n];r?e[n]=r(s[n],t):e[n]=t[n]}return e}downloadData(t="BIM Table Data",e="json"){let s=null;if(e==="json"&&(s=new File([JSON.stringify(this.value,void 0,2)],`${t}.json`)),e==="csv"&&(s=new File([this.csv],`${t}.csv`)),e==="tsv"&&(s=new File([this.tsv],`${t}.tsv`)),!s)return;const n=document.createElement("a");n.href=URL.createObjectURL(s),n.download=s.name,n.click(),URL.revokeObjectURL(n.href)}getRowIndentation(t,e=this.value,s=0){for(const n of e){if(n.data===t)return s;if(n.children){const r=this.getRowIndentation(t,n.children,s+1);if(r!==null)return r}}return null}getGroupIndentation(t,e=this.value,s=0){for(const n of e){if(n===t)return s;if(n.children){const r=this.getGroupIndentation(t,n.children,s+1);if(r!==null)return r}}return null}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event("connected"))}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event("disconnected"))}async loadData(t=!1){if(this._filteredData.length!==0&&!t||!this.loadFunction)return!1;this.loading=!0;try{const e=await this.loadFunction();return this.data=e,this.loading=!1,this._errorLoading=!1,!0}catch(e){if(this.loading=!1,this._filteredData.length!==0)return!1;const s=this.querySelector("[slot='error-loading']"),n=s==null?void 0:s.querySelector("[data-table-element='error-message']");return e instanceof Error&&n&&e.message.trim()!==""&&(n.textContent=e.message),this._errorLoading=!0,!1}}filter(t,e=this.filterFunction??this._stringFilterFunction,s=this.data){const n=[];for(const r of s)if(e(t,r)){if(this.preserveStructureOnFilter){const a={data:r.data};if(r.children){const l=this.filter(t,e,r.children);l.length&&(a.children=l)}n.push(a)}else if(n.push({data:r.data}),r.children){const a=this.filter(t,e,r.children);n.push(...a)}}else if(r.children){const a=this.filter(t,e,r.children);this.preserveStructureOnFilter&&a.length?n.push({data:r.data,children:a}):n.push(...a)}return n}get _missingDataElement(){return this.querySelector("[slot='missing-data']")}render(){if(this.loading)return to();if(this._errorLoading)return f`<slot name="error-loading"></slot>`;if(this._filteredData.length===0&&this._missingDataElement)return f`<slot name="missing-data"></slot>`;const t=document.createElement("bim-table-row");t.table=this,t.isHeader=!0,t.data=this._headerRowData,t.style.gridArea="Header",t.style.position="sticky",t.style.top="0",t.style.zIndex="5";const e=document.createElement("bim-table-children");return e.table=this,e.data=this.value,e.style.gridArea="Body",e.style.backgroundColor="transparent",f`
    ...
    `];let X=vi;jt([It()],X.prototype,"_switchers",2);jt([d({type:Boolean,reflect:!0})],X.prototype,"bottom",2);jt([d({type:Boolean,attribute:"switchers-hidden",reflect:!0})],X.prototype,"switchersHidden",2);jt([d({type:Boolean,reflect:!0})],X.prototype,"floating",2);jt([d({type:String,reflect:!0})],X.prototype,"tab",1);jt([d({type:Boolean,attribute:"switchers-full",reflect:!0})],X.prototype,"switchersFull",2);var fo=Object.defineProperty,mo=Object.getOwnPropertyDescriptor,Ee=(i,t,e,s)=>{for(var n=s>1?void 0:s?mo(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&fo(t,e,n),n};const yi=class yi extends k{constructor(){super(...arguments),this._defaultName="__unnamed__",this.name=this._defaultName,this._hidden=!1}set label(t){this._label=t;const e=this.parentElement;e instanceof X&&e.updateSwitchers()}get label(){return this._label}set hidden(t){this._hidden=t;const e=this.parentElement;e!=null&&e.hasAttribute("floating")&&this.style.setProperty("animation",t?"hideFloatingTabSmoothly 0.6s linear forwards":"none"),this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}connectedCallback(){super.connectedCallback();const{parentElement:t}=this;if(t&&this.name===this._defaultName){const e=[...t.children].indexOf(this);this.name=`${this._defaultName}${e}`}}render(){return f` <slot></slot> `}};yi.styles=$`
    :host {
      display: block;
      height: 100%;
      grid-row-start: 1;
