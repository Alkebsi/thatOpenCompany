 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ei=globalThis,Si=Ei.trustedTypes,mo=Si?Si.createPolicy("lit-html",{createHTML:e=>e}):void 0,Rs="$lit$",$t=`lit$${Math.random().toFixed(9).slice(2)}$`,Ms="?"+$t,El=`<${Ms}>`,Vt=document,De=()=>Vt.createComment(""),He=e=>e===null||typeof e!="object"&&typeof e!="function",Ln=Array.isArray,Sl=e=>Ln(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",on=`[ 	
\f\r]`,ke=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,fo=/-->/g,bo=/>/g,Lt=RegExp(`>|${on}(?:([^\\s"'>=/]+)(${on}*=${on}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),go=/'/g,vo=/"/g,Ls=/^(?:script|style|textarea|title)$/i,kl=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),m=kl(1),qt=Symbol.for("lit-noChange"),M=Symbol.for("lit-nothing"),yo=new WeakMap,jt=Vt.createTreeWalker(Vt,129);function zs(e,t){if(!Ln(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return mo!==void 0?mo.createHTML(t):t}const Tl=(e,t)=>{const i=e.length-1,n=[];let o,s=t===2?"<svg>":t===3?"<math>":"",r=ke;for(let a=0;a<i;a++){const l=e[a];let u,d,c=-1,h=0;for(;h<l.length&&(r.lastIndex=h,d=r.exec(l),d!==null);)h=r.lastIndex,r===ke?d[1]==="!--"?r=fo:d[1]!==void 0?r=bo:d[2]!==void 0?(Ls.test(d[2])&&(o=RegExp("</"+d[2],"g")),r=Lt):d[3]!==void 0&&(r=Lt):r===Lt?d[0]===">"?(r=o??ke,c=-1):d[1]===void 0?c=-2:(c=r.lastIndex-d[2].length,u=d[1],r=d[3]===void 0?Lt:d[3]==='"'?vo:go):r===vo||r===go?r=Lt:r===fo||r===bo?r=ke:(r=Lt,o=void 0);const p=r===Lt&&e[a+1].startsWith("/>")?" ":"";s+=r===ke?l+El:c>=0?(n.push(u),l.slice(0,c)+Rs+l.slice(c)+$t+p):l+$t+(c===-2?a:p)}return[zs(e,s+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]};class Fe{constructor({strings:t,_$litType$:i},n){let o;this.parts=[];let s=0,r=0;const a=t.length-1,l=this.parts,[u,d]=Tl(t,i);if(this.el=Fe.createElement(u,n),jt.currentNode=this.el.content,i===2||i===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(o=jt.nextNode())!==null&&l.length<a;){if(o.nodeType===1){if(o.hasAttributes())for(const c of o.getAttributeNames())if(c.endsWith(Rs)){const h=d[r++],p=o.getAttribute(c).split($t),b=/([.?@])?(.*)/.exec(h);l.push({type:1,index:s,name:b[2],strings:p,ctor:b[1]==="."?Pl:b[1]==="?"?Il:b[1]==="@"?Nl:Vi}),o.removeAttribute(c)}else c.startsWith($t)&&(l.push({type:6,index:s}),o.removeAttribute(c));if(Ls.test(o.tagName)){const c=o.textContent.split($t),h=c.length-1;if(h>0){o.textContent=Si?Si.emptyScript:"";for(let p=0;p<h;p++)o.append(c[p],De()),jt.nextNode(),l.push({type:2,index:++s});o.append(c[h],De())}}}else if(o.nodeType===8)if(o.data===Ms)l.push({type:2,index:s});else{let c=-1;for(;(c=o.data.indexOf($t,c+1))!==-1;)l.push({type:7,index:s}),c+=$t.length-1}s++}}static createElement(t,i){const n=Vt.createElement("template");return n.innerHTML=t,n}}function le(e,t,i=e,n){var o,s;if(t===qt)return t;let r=n!==void 0?(o=i._$Co)==null?void 0:o[n]:i._$Cl;const a=He(t)?void 0:t._$litDirective$;return(r==null?void 0:r.constructor)!==a&&((s=r==null?void 0:r._$AO)==null||s.call(r,!1),a===void 0?r=void 0:(r=new a(e),r._$AT(e,i,n)),n!==void 0?(i._$Co??(i._$Co=[]))[n]=r:i._$Cl=r),r!==void 0&&(t=le(e,r._$AS(e,t.values),r,n)),t}class Ol{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:n}=this._$AD,o=((t==null?void 0:t.creationScope)??Vt).importNode(i,!0);jt.currentNode=o;let s=jt.nextNode(),r=0,a=0,l=n[0];for(;l!==void 0;){if(r===l.index){let u;l.type===2?u=new ti(s,s.nextSibling,this,t):l.type===1?u=new l.ctor(s,l.name,l.strings,this,t):l.type===6&&(u=new Rl(s,this,t)),this._$AV.push(u),l=n[++a]}r!==(l==null?void 0:l.index)&&(s=jt.nextNode(),r++)}return jt.currentNode=Vt,o}p(t){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,i),i+=n.strings.length-2):n._$AI(t[i])),i++}}class ti{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,i,n,o){this.type=2,this._$AH=M,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=n,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=le(this,t,i),He(t)?t===M||t==null||t===""?(this._$AH!==M&&this._$AR(),this._$AH=M):t!==this._$AH&&t!==qt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Sl(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==M&&He(this._$AH)?this._$AA.nextSibling.data=t:this.T(Vt.createTextNode(t)),this._$AH=t}$(t){var i;const{values:n,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Fe.createElement(zs(o.h,o.h[0]),this.options)),o);if(((i=this._$AH)==null?void 0:i._$AD)===s)this._$AH.p(n);else{const r=new Ol(s,this),a=r.u(this.options);r.p(n),this.T(a),this._$AH=r}}_$AC(t){let i=yo.get(t.strings);return i===void 0&&yo.set(t.strings,i=new Fe(t)),i}k(t){Ln(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,o=0;for(const s of t)o===i.length?i.push(n=new ti(this.O(De()),this.O(De()),this,this.options)):n=i[o],n._$AI(s),o++;o<i.length&&(this._$AR(n&&n._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,i);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var i;this._$AM===void 0&&(this._$Cv=t,(i=this._$AP)==null||i.call(this,t))}}class Vi{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,n,o,s){this.type=1,this._$AH=M,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=M}_$AI(t,i=this,n,o){const s=this.strings;let r=!1;if(s===void 0)t=le(this,t,i,0),r=!He(t)||t!==this._$AH&&t!==qt,r&&(this._$AH=t);else{const a=t;let l,u;for(t=s[0],l=0;l<s.length-1;l++)u=le(this,a[n+l],i,l),u===qt&&(u=this._$AH[l]),r||(r=!He(u)||u!==this._$AH[l]),u===M?t=M:t!==M&&(t+=(u??"")+s[l+1]),this._$AH[l]=u}r&&!o&&this.j(t)}j(t){t===M?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Pl extends Vi{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===M?void 0:t}}class Il extends Vi{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==M)}}class Nl extends Vi{constructor(t,i,n,o,s){super(t,i,n,o,s),this.type=5}_$AI(t,i=this){if((t=le(this,t,i,0)??M)===qt)return;const n=this._$AH,o=t===M&&n!==M||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,s=t!==M&&(n===M||o);o&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,t):this._$AH.handleEvent(t)}}class Rl{constructor(t,i,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){le(this,t)}}const _o=Ei.litHtmlPolyfillSupport;_o==null||_o(Fe,ti),(Ei.litHtmlVersions??(Ei.litHtmlVersions=[])).push("3.2.1");const ce=(e,t,i)=>{const n=(i==null?void 0:i.renderBefore)??t;let o=n._$litPart$;if(o===void 0){const s=(i==null?void 0:i.renderBefore)??null;n._$litPart$=o=new ti(t.insertBefore(De(),s),s,void 0,i??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const js={ATTRIBUTE:1,CHILD:2},Ds=e=>(...t)=>({_$litDirective$:e,values:t});let Hs=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ne=(e,t)=>{var i;const n=e._$AN;if(n===void 0)return!1;for(const o of n)(i=o._$AO)==null||i.call(o,t,!1),Ne(o,t);return!0},ki=e=>{let t,i;do{if((t=e._$AM)===void 0)break;i=t._$AN,i.delete(e),e=t}while((i==null?void 0:i.size)===0)},Fs=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(i===void 0)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Hl(t)}};function jl(e){this._$AN!==void 0?(ki(this),this._$AM=e,Fs(this)):this._$AM=e}function Dl(e,t=!1,i=0){const n=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(n))for(let s=i;s<n.length;s++)Ne(n[s],!1),ki(n[s]);else n!=null&&(Ne(n,!1),ki(n));else Ne(this,e)}const Hl=e=>{e.type==js.CHILD&&(e._$AP??(e._$AP=Dl),e._$AQ??(e._$AQ=jl))};class Fl extends Hs{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,i,n){super._$AT(t,i,n),Fs(this),this.isConnected=t._$AU}_$AO(t,i=!0){var n,o;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)==null||n.call(this):(o=this.disconnected)==null||o.call(this)),i&&(Ne(this,t),ki(this))}setValue(t){if(zl(this._$Ct))this._$Ct._$AI(t,this);else{const i=[...this._$Ct._$AH];i[this._$Ci]=t,this._$Ct._$AI(i,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ue=()=>new Bl;class Bl{}const sn=new WeakMap,W=Ds(class extends Fl{render(e){return M}update(e,[t]){var i;const n=t!==this.Y;return n&&this.Y!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.Y=t,this.ht=(i=e.options)==null?void 0:i.host,this.rt(this.ct=e.element)),M}rt(e){if(this.isConnected||(e=void 0),typeof this.Y=="function"){const t=this.ht??globalThis;let i=sn.get(t);i===void 0&&(i=new WeakMap,sn.set(t,i)),i.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),i.set(this.Y,e),e!==void 0&&this.Y.call(this.ht,e)}else this.Y.value=e}get lt(){var e,t;return typeof this.Y=="function"?(e=sn.get(this.ht??globalThis))==null?void 0:e.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});/**
* (c) Iconify
*
...
`,Tt={scrollbar:Wc,globalStyles:Yc},ur=class k{static set config(t){this._config={...k._config,...t}}static get config(){return k._config}static addGlobalStyles(){let t=document.querySelector("style[id='bim-ui']");if(t)return;t=document.createElement("style"),t.id="bim-ui",t.textContent=Tt.globalStyles.cssText;const i=document.head.firstChild;i?document.head.insertBefore(t,i):document.head.append(t)}static defineCustomElement(t,i){customElements.get(t)||customElements.define(t,i)}static registerComponents(){k.init()}static init(t="",i=!0){k.addGlobalStyles(),k.defineCustomElement("bim-button",eu),k.defineCustomElement("bim-checkbox",ge),k.defineCustomElement("bim-color-input",Gt),k.defineCustomElement("bim-context-menu",Cn),k.defineCustomElement("bim-dropdown",vt),k.defineCustomElement("bim-grid",Vn),k.defineCustomElement("bim-icon",cu),k.defineCustomElement("bim-input",oi),k.defineCustomElement("bim-label",ye),k.defineCustomElement("bim-number-input",K),k.defineCustomElement("bim-option",F),k.defineCustomElement("bim-panel",Xt),k.defineCustomElement("bim-panel-section",_e),k.defineCustomElement("bim-selector",we),k.defineCustomElement("bim-table",st),k.defineCustomElement("bim-tabs",It),k.defineCustomElement("bim-tab",X),k.defineCustomElement("bim-table-cell",Ar),k.defineCustomElement("bim-table-children",Sr),k.defineCustomElement("bim-table-group",Tr),k.defineCustomElement("bim-table-row",Jt),k.defineCustomElement("bim-text-input",rt),k.defineCustomElement("bim-toolbar",Zi),k.defineCustomElement("bim-toolbar-group",Ji),k.defineCustomElement("bim-toolbar-section",Ce),k.defineCustomElement("bim-viewport",Hr),i&&this.animateOnLoad(t)}static newRandomId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";let i="";for(let n=0;n<10;n++){const o=Math.floor(Math.random()*t.length);i+=t.charAt(o)}return i}static animateOnLoad(t=""){const i=`
      bim-input,
      bim-button,
      bim-checkbox,
      bim-selector,
    ...
    `],H.dialog=j.create(()=>m` <dialog
      ...
      background-color: transparent;
    "
    ></dialog>`),H.menus=[],H);dr([v({type:String,reflect:!0})],Un.prototype,"placement");dr([v({type:Boolean,reflect:!0})],Un.prototype,"visible");let Cn=Un;const Qc=()=>{let e=!1;return(t=>{(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(t)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw-(n|u)|c55\/|capi|ccwa|cdm-|cell|chtm|cldc|cmd-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc-s|devi|dica|dmob|do(c|p)o|ds(12|-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(-|_)|g1 u|g560|gene|gf-5|g-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd-(m|p|t)|hei-|hi(pt|ta)|hp( i|ip)|hs-c|ht(c(-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i-(20|go|ma)|i230|iac( |-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|-[a-w])|libw|lynx|m1-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|-([1-8]|c))|phil|pire|pl(ay|uc)|pn-2|po(ck|rt|se)|prox|psio|pt-g|qa-a|qc(07|12|21|32|60|-[2-7]|i-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h-|oo|p-)|sdk\/|se(c(-|0|1)|47|mc|nd|ri)|sgh-|shar|sie(-|m)|sk-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h-|v-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl-|tdg-|tel(i|m)|tim-|t-mo|to(pl|sh)|ts(70|m-|m3|m5)|tx-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas-|your|zeto|zte-/i.test(t.substr(0,4)))&&(e=!0)})(navigator.userAgent),e},Zc=()=>matchMedia("(hover: none), (pointer: coarse)").matches;var Kc=Object.defineProperty,tu=Object.getOwnPropertyDescriptor,lt=(e,t,i,n)=>{for(var o=n>1?void 0:n?tu(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Kc(t,i,o),o},Te;const nt=(Te=class extends T{constructor(){super(),this.labelHidden=!1,this.active=!1,this.disabled=!1,this.vertical=!1,this.tooltipVisible=!1,this._stateBeforeLoading={disabled:!1,icon:""},this._loading=!1,this._parent=ue(),this._tooltip=ue(),this._tooltipHidden=!1,this.onClick=e=>{e.stopPropagation(),this.disabled||this.dispatchEvent(new Event("click"))},this.showContextMenu=()=>{const e=this._contextMenu;if(e){const t=this.getAttribute("data-context-group");t&&e.setAttribute("data-context-group",t),this.closeNestedContexts();const i=Z.newRandomId();for(const n of e.children)n instanceof Te&&n.setAttribute("data-context-group",i);e.visible=!0}},this.tooltipHidden=!0}set loading(e){if(this._loading=e,e)this._stateBeforeLoading={disabled:this.disabled,icon:this.icon},this.disabled=e,this.icon="eos-icons:loading";else{const{disabled:t,icon:i}=this._stateBeforeLoading;this.disabled=t,this.icon=i}}get loading(){return this._loading}set tooltipHidden(e){this._tooltipHidden=e,e&&(this.tooltipVisible=!1,clearTimeout(this.timeoutID))}get tooltipHidden(){return this._tooltipHidden}computeTooltipPosition(){const{value:e}=this._parent,{value:t}=this._tooltip;e&&t&&Is(e,t,{placement:"bottom",middleware:[vs(10),Ps(),Os(),Ts({padding:5})]}).then(i=>{const{x:n,y:o}=i;Object.assign(t.style,{left:`${n}px`,top:`${o}px`})})}showTooltip(){if(!(this.tooltipTitle||this.tooltipText))return;this.tooltipHidden=!1;const e=this.tooltipTime??700;this.timeoutID=setTimeout(()=>{this.tooltipHidden||(this.computeTooltipPosition(),this.tooltipVisible=!0)},e)}closeNestedContexts(){const e=this.getAttribute("data-context-group");if(e)for(const t of Cn.dialog.children){const i=t.getAttribute("data-context-group");if(t instanceof Cn&&i===e){t.visible=!1,t.removeAttribute("data-context-group");for(const n of t.children)n instanceof Te&&(n.closeNestedContexts(),n.removeAttribute("data-context-group"))}}}click(){this.disabled||super.click()}get _contextMenu(){return this.querySelector("bim-context-menu")}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.showContextMenu),this.addTooltipEvents()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.showContextMenu)}addTooltipEvents(){Qc()||Zc()?this.addEventListener("contextmenu",e=>{e.preventDefault(),this.tooltipTime=0,this.showTooltip()}):this.addEventListener("mouseenter",this.showTooltip),this.addEventListener("mouseleave",()=>{this.tooltipHidden=!0})}render(){const e=m`
  ...
  `,Te);lt([v({type:String,reflect:!0})],nt.prototype,"label",2);lt([v({type:Boolean,attribute:"label-hidden",reflect:!0})],nt.prototype,"labelHidden",2);lt([v({type:Boolean,reflect:!0})],nt.prototype,"active",2);lt([v({type:Boolean,reflect:!0,attribute:"disabled"})],nt.prototype,"disabled",2);lt([v({type:String,reflect:!0})],nt.prototype,"icon",2);lt([v({type:Boolean,reflect:!0})],nt.prototype,"vertical",2);lt([v({type:Number,attribute:"tooltip-time",reflect:!0})],nt.prototype,"tooltipTime",2);lt([v({type:Boolean,attribute:"tooltip-visible",reflect:!0})],nt.prototype,"tooltipVisible",2);lt([v({type:String,attribute:"tooltip-title",reflect:!0})],nt.prototype,"tooltipTitle",2);lt([v({type:String,attribute:"tooltip-text",reflect:!0})],nt.prototype,"tooltipText",2);lt([v({type:Boolean,reflect:!0})],nt.prototype,"loading",1);let eu=nt;var iu=Object.defineProperty,ni=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&iu(t,i,o),o};const hr=class extends T{constructor(){super(...arguments),this.checked=!1,this.inverted=!1,this.onValueChange=new Event("change")}get value(){return this.checked}onChange(e){e.stopPropagation(),this.checked=e.target.checked,this.dispatchEvent(this.onValueChange)}render(){const e=m`
  ...
  `;let Gt=pr;ve([v({type:String,reflect:!0})],Gt.prototype,"name");ve([v({type:String,reflect:!0})],Gt.prototype,"label");ve([v({type:String,reflect:!0})],Gt.prototype,"icon");ve([v({type:Boolean,reflect:!0})],Gt.prototype,"vertical");ve([v({type:Number,reflect:!0})],Gt.prototype,"opacity");ve([v({type:String,reflect:!0})],Gt.prototype,"color");var ou=Object.defineProperty,su=Object.getOwnPropertyDescriptor,Ot=(e,t,i,n)=>{for(var o=n>1?void 0:n?su(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ou(t,i,o),o};const mr=class extends T{constructor(){super(...arguments),this.checked=!1,this.checkbox=!1,this.noMark=!1,this.vertical=!1}get value(){return this._value!==void 0?this._value:this.label?Yi(this.label):this.label}set value(e){this._value=e}render(){return m`
  ...
  `;let F=mr;Ot([v({type:String,reflect:!0})],F.prototype,"img",2);Ot([v({type:String,reflect:!0})],F.prototype,"label",2);Ot([v({type:String,reflect:!0})],F.prototype,"icon",2);Ot([v({type:Boolean,reflect:!0})],F.prototype,"checked",2);Ot([v({type:Boolean,reflect:!0})],F.prototype,"checkbox",2);Ot([v({type:Boolean,attribute:"no-mark",reflect:!0})],F.prototype,"noMark",2);Ot([v({converter:{fromAttribute(e){return e&&Yi(e)}}})],F.prototype,"value",1);Ot([v({type:Boolean,reflect:!0})],F.prototype,"vertical",2);var ru=Object.defineProperty,au=Object.getOwnPropertyDescriptor,Pt=(e,t,i,n)=>{for(var o=n>1?void 0:n?au(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ru(t,i,o),o};const fr=class extends j{constructor(){super(),this.multiple=!1,this.required=!1,this.vertical=!1,this._visible=!1,this._value=new Set,this.onValueChange=new Event("change"),this._contextMenu=ue(),this.onOptionClick=e=>{const t=e.target,i=this._value.has(t);if(!this.multiple&&!this.required&&!i)this._value=new Set([t]);else if(!this.multiple&&!this.required&&i)this._value=new Set([]);else if(!this.multiple&&this.required&&!i)this._value=new Set([t]);else if(this.multiple&&!this.required&&!i)this._value=new Set([...this._value,t]);else if(this.multiple&&!this.required&&i){const n=[...this._value].filter(o=>o!==t);this._value=new Set(n)}else if(this.multiple&&this.required&&!i)this._value=new Set([...this._value,t]);else if(this.multiple&&this.required&&i){const n=[...this._value].filter(s=>s!==t),o=new Set(n);o.size!==0&&(this._value=o)}this.updateOptionsState(),this.dispatchEvent(this.onValueChange)},this.useObserver=!0}set visible(e){if(e){const{value:t}=this._contextMenu;if(!t)return;for(const i of this.elements)t.append(i);this._visible=!0}else{for(const t of this.elements)this.append(t);this._visible=!1,this.resetVisibleElements()}}get visible(){return this._visible}set value(e){if(this.required&&Object.keys(e).length===0)return;const t=new Set;for(const i of e){const n=this.findOption(i);if(n&&(t.add(n),!this.multiple&&Object.keys(e).length===1))break}this._value=t,this.updateOptionsState(),this.dispatchEvent(this.onValueChange)}get value(){return[...this._value].filter(e=>e instanceof F&&e.checked).map(e=>e.value)}get _options(){const e=new Set([...this.elements]);for(const t of this.children)t instanceof F&&e.add(t);return[...e]}onSlotChange(e){const t=e.target.assignedElements();this.observe(t);const i=new Set;for(const n of this.elements){if(!(n instanceof F)){n.remove();continue}n.checked&&i.add(n),n.removeEventListener("click",this.onOptionClick),n.addEventListener("click",this.onOptionClick)}this._value=i}updateOptionsState(){for(const e of this._options)e instanceof F&&(e.checked=this._value.has(e))}findOption(e){return this._options.find(t=>t instanceof F?t.label===e||t.value===e:!1)}render(){let e,t,i;if(this._value.size===0)e="Select an option...";else if(this._value.size===1){const n=[...this._value][0];e=(n==null?void 0:n.label)||(n==null?void 0:n.value),t=n==null?void 0:n.img,i=n==null?void 0:n.icon}else e=`Multiple (${this._value.size})`;return m`
    ...
    `];let vt=fr;Pt([v({type:String,reflect:!0})],vt.prototype,"name",2);Pt([v({type:String,reflect:!0})],vt.prototype,"icon",2);Pt([v({type:String,reflect:!0})],vt.prototype,"label",2);Pt([v({type:Boolean,reflect:!0})],vt.prototype,"multiple",2);Pt([v({type:Boolean,reflect:!0})],vt.prototype,"required",2);Pt([v({type:Boolean,reflect:!0})],vt.prototype,"vertical",2);Pt([v({type:Boolean,reflect:!0})],vt.prototype,"visible",1);Pt([be()],vt.prototype,"_value",2);var lu=Object.defineProperty,br=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&lu(t,i,o),o};const gr=class extends T{constructor(){super(...arguments),this.floating=!1,this._layouts={},this._updateFunctions={}}set layouts(e){this._layouts=e;const t={};for(const[i,n]of Object.entries(e))for(const o in n.elements)t[i]||(t[i]={}),t[i][o]=s=>{const r=this._updateFunctions[i];if(!r)return;const a=r[o];a&&a(s)};this.updateComponent=t}get layouts(){return this._layouts}getLayoutAreas(e){const{template:t}=e,i=t.split(`
`).map(n=>n.trim()).map(n=>n.split('"')[1]).filter(n=>n!==void 0).flatMap(n=>n.split(/\s+/));return[...new Set(i)].filter(n=>n!=="")}firstUpdated(){this._onLayoutChange=new Event("layoutchange")}render(){if(this.layout){if(this._updateFunctions={},this.layouts[this.layout]){this.innerHTML="",this._updateFunctions[this.layout]={};const e=this._updateFunctions[this.layout],t=this.layouts[this.layout],i=this.getLayoutAreas(t).map(n=>{const o=t.elements[n];if(!o)return null;if(o instanceof HTMLElement)return o.style.gridArea=n,o;if("template"in o){const{template:s,initialState:r}=o,[a,l]=j.create(s,r);return a.style.gridArea=n,e[n]=l,a}return j.create(o)}).filter(n=>!!n);this.style.gridTemplate=t.template,this.append(...i),this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange)}}else this._updateFunctions={},this.innerHTML="",this.style.gridTemplate="",this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange);return m`<slot></slot>`}};gr.styles=P`
    :host {
      display: grid;
      height: 100%;
      width: 100%;
  ...
  `;let ye=yr;si([v({type:String,reflect:!0})],ye.prototype,"img");si([v({type:Boolean,attribute:"label-hidden",reflect:!0})],ye.prototype,"labelHidden");si([v({type:String,reflect:!0})],ye.prototype,"icon");si([v({type:Boolean,attribute:"icon-hidden",reflect:!0})],ye.prototype,"iconHidden");si([v({type:Boolean,reflect:!0})],ye.prototype,"vertical");var hu=Object.defineProperty,pu=Object.getOwnPropertyDescriptor,ot=(e,t,i,n)=>{for(var o=n>1?void 0:n?pu(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&hu(t,i,o),o};const _r=class extends T{constructor(){super(...arguments),this._value=0,this.vertical=!1,this.slider=!1,this._input=ue(),this.onValueChange=new Event("change")}set value(e){this.setValue(e.toString())}get value(){return this._value}onChange(e){e.stopPropagation();const{value:t}=this._input;t&&this.setValue(t.value)}setValue(e){const{value:t}=this._input;let i=e;if(i=i.replace(/[^0-9.-]/g,""),i=i.replace(/(\..*)\./g,"$1"),i.endsWith(".")||(i.lastIndexOf("-")>0&&(i=i[0]+i.substring(1).replace(/-/g,"")),i==="-"||i==="-0"))return;let n=Number(i);Number.isNaN(n)||(n=this.min!==void 0?Math.max(n,this.min):n,n=this.max!==void 0?Math.min(n,this.max):n,this.value!==n&&(this._value=n,t&&(t.value=this.value.toString()),this.requestUpdate(),this.dispatchEvent(this.onValueChange)))}onBlur(){const{value:e}=this._input;e&&Number.isNaN(Number(e.value))&&(e.value=this.value.toString())}onSliderPointerDown(e){const t=e.pointerType==="touch",i=.5;document.body.style.cursor="w-resize";const{clientX:n}=e,o=this.value;let s=!1;const r=u=>{var d;s=!0;const c=u instanceof TouchEvent?u.touches[0].clientX:u.clientX;console.log(c);const h=this.step??1,p=((d=h.toString().split(".")[1])==null?void 0:d.length)||0;let b=1/(this.sensitivity??1);b*=t?i:1;const y=(c-n)/b;if(Math.floor(Math.abs(y))!==Math.abs(y)&&!t)return;const g=o+y*h;this.setValue(g.toFixed(p))},a=()=>{this.slider=!0,this.removeEventListener("blur",a)},l=()=>{document.removeEventListener(`${t?"touch":"mouse"}move`,r),document.body.style.cursor="default",s?s=!1:(this.addEventListener("blur",a),this.slider=!1,requestAnimationFrame(()=>this.focus())),document.removeEventListener(`${t?"touchend":"mouseup"}`,l)};document.addEventListener(`${t?"touch":"mouse"}move`,r),document.addEventListener(`${t?"touchend":"mouseup"}`,l)}onFocus(e){e.stopPropagation();const t=i=>{i.key==="Escape"&&(this.blur(),window.removeEventListener("keydown",t))};window.addEventListener("keydown",t)}connectedCallback(){super.connectedCallback(),this.min&&this.min>this.value&&(this._value=this.min),this.max&&this.max<this.value&&(this._value=this.max)}focus(){const{value:e}=this._input;e&&e.focus()}render(){const e=m`
  ...
  `;let we=$r;li([v({type:String,reflect:!0})],we.prototype,"name");li([v({type:String,reflect:!0})],we.prototype,"icon");li([v({type:String,reflect:!0})],we.prototype,"label");li([v({type:Boolean,reflect:!0})],we.prototype,"vertical");li([be()],we.prototype,"_value");const vu=()=>m`
    <style>
      div {
        display: flex;
        gap: 0.375rem;
  ...
  `;var _u=Object.defineProperty,wu=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&_u(t,i,o),o};const Cr=class extends T{constructor(){super(...arguments),this.column="",this.columnIndex=0,this.rowData={}}get data(){return this.column?this.rowData[this.column]:null}render(){return m`
      <style>
        :host {
  ...
  `;let Ar=Cr;wu([v({type:String,reflect:!0})],Ar.prototype,"column");var xu=Object.defineProperty,$u=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&xu(t,i,o),o};const Er=class extends T{constructor(){super(...arguments),this._groups=[],this.data=[],this.table=this.closest("bim-table")}toggleGroups(e,t=!1){for(const i of this._groups)i.childrenHidden=typeof e>"u"?!i.childrenHidden:!e,t&&i.toggleChildren(e,t)}render(){return this._groups=[],m`
      <slot></slot>
  ...
  `;let Tr=kr;Au([v({type:Boolean,attribute:"children-hidden",reflect:!0})],Tr.prototype,"childrenHidden");var Eu=Object.defineProperty,xe=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&Eu(t,i,o),o};const Or=class extends T{constructor(){super(...arguments),this.selected=!1,this.columns=[],this.hiddenColumns=[],this.data={},this.isHeader=!1,this.table=this.closest("bim-table"),this.onTableColumnsChange=()=>{this.table&&(this.columns=this.table.columns)},this.onTableColumnsHidden=()=>{this.table&&(this.hiddenColumns=this.table.hiddenColumns)},this._observer=new IntersectionObserver(e=>{this._intersecting=e[0].isIntersecting},{rootMargin:"36px"})}get _columnNames(){return this.columns.filter(e=>!this.hiddenColumns.includes(e.name)).map(e=>e.name)}get _columnWidths(){return this.columns.filter(e=>!this.hiddenColumns.includes(e.name)).map(e=>e.width)}get _isSelected(){var e;return(e=this.table)==null?void 0:e.selection.has(this.data)}onSelectionChange(e){if(!this.table)return;const t=e.target;this.selected=t.value,t.value?(this.table.selection.add(this.data),this.table.dispatchEvent(new CustomEvent("rowselected",{detail:{data:this.data}}))):(this.table.selection.delete(this.data),this.table.dispatchEvent(new CustomEvent("rowdeselected",{detail:{data:this.data}})))}connectedCallback(){super.connectedCallback(),this._observer.observe(this),this.table&&(this.columns=this.table.columns,this.hiddenColumns=this.table.hiddenColumns,this.table.addEventListener("columnschange",this.onTableColumnsChange),this.table.addEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",this._isSelected))}disconnectedCallback(){super.disconnectedCallback(),this._observer.unobserve(this),this.table&&(this.columns=[],this.hiddenColumns=[],this.table.removeEventListener("columnschange",this.onTableColumnsChange),this.table.removeEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",!1))}compute(){if(!this.table)throw new Error("TableRow: parent table wasn't found!");const e=this.table.getRowIndentation(this.data)??0,t=this.isHeader?this.data:this.table.applyDataTransform(this.data)??this.data,i=[];for(const n in t){if(this.hiddenColumns.includes(n))continue;const o=t[n];let s;if(typeof o=="string"||typeof o=="boolean"||typeof o=="number"?(s=document.createElement("bim-label"),s.textContent=String(o)):o instanceof HTMLElement?s=o:(s=document.createDocumentFragment(),ce(o,s)),!s)continue;const r=document.createElement("bim-table-cell");r.append(s),r.column=n,this._columnNames.indexOf(n)===0&&(r.style.marginLeft=`${this.table.noIndentation?0:e+.75}rem`);const a=this._columnNames.indexOf(n);r.setAttribute("data-column-index",String(a)),r.toggleAttribute("data-no-indentation",a===0&&this.table.noIndentation),r.toggleAttribute("data-cell-header",this.isHeader),r.rowData=this.data,this.table.dispatchEvent(new CustomEvent("cellcreated",{detail:{cell:r}})),i.push(r)}return this.style.gridTemplateAreas=`"${this.table.selectableRows?"Selection":""} ${this._columnNames.join(" ")}"`,this.style.gridTemplateColumns=`${this.table.selectableRows?"1.6rem":""} ${this._columnWidths.join(" ")}`,m`
 ...
 */const Uo=e=>e??M;var Nu=Object.defineProperty,Ru=Object.getOwnPropertyDescriptor,yt=(e,t,i,n)=>{for(var o=n>1?void 0:n?Ru(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Nu(t,i,o),o};const Rr=class extends T{constructor(){super(...arguments),this._inputTypes=["date","datetime-local","email","month","password","search","tel","text","time","url","week","area"],this.value="",this.vertical=!1,this._type="text",this.onValueChange=new Event("input")}set type(e){this._inputTypes.includes(e)&&(this._type=e)}get type(){return this._type}get query(){return $n(this.value)}onInputChange(e){e.stopPropagation();const t=e.target;clearTimeout(this._debounceTimeoutID),this._debounceTimeoutID=setTimeout(()=>{this.value=t.value,this.dispatchEvent(this.onValueChange)},this.debounce)}focus(){setTimeout(()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()})}render(){return m`
    ...
    `];let rt=Rr;yt([v({type:String,reflect:!0})],rt.prototype,"icon",2);yt([v({type:String,reflect:!0})],rt.prototype,"label",2);yt([v({type:String,reflect:!0})],rt.prototype,"name",2);yt([v({type:String,reflect:!0})],rt.prototype,"placeholder",2);yt([v({type:String,reflect:!0})],rt.prototype,"value",2);yt([v({type:Boolean,reflect:!0})],rt.prototype,"vertical",2);yt([v({type:Number,reflect:!0})],rt.prototype,"debounce",2);yt([v({type:Number,reflect:!0})],rt.prototype,"rows",2);yt([v({type:String,reflect:!0})],rt.prototype,"type",1);var Mu=Object.defineProperty,Lu=Object.getOwnPropertyDescriptor,Mr=(e,t,i,n)=>{for(var o=n>1?void 0:n?Lu(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Mu(t,i,o),o};const Lr=class extends T{constructor(){super(...arguments),this.rows=2,this._vertical=!1}set vertical(e){this._vertical=e,this.updateChildren()}get vertical(){return this._vertical}updateChildren(){const e=this.children;for(const t of e)this.vertical?t.setAttribute("label-hidden",""):t.removeAttribute("label-hidden")}render(){return m`
      <style>
        .parent {
  ...
  `;let Ji=Lr;Mr([v({type:Number,reflect:!0})],Ji.prototype,"rows",2);Mr([v({type:Boolean,reflect:!0})],Ji.prototype,"vertical",1);var zu=Object.defineProperty,ju=Object.getOwnPropertyDescriptor,Qi=(e,t,i,n)=>{for(var o=n>1?void 0:n?ju(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&zu(t,i,o),o};const zr=class extends T{constructor(){super(...arguments),this._vertical=!1,this._labelHidden=!1}set vertical(e){this._vertical=e,this.updateChildren()}get vertical(){return this._vertical}set labelHidden(e){this._labelHidden=e,this.updateChildren()}get labelHidden(){return this._labelHidden}updateChildren(){const e=this.children;for(const t of e)t instanceof Ji&&(t.vertical=this.vertical),t.toggleAttribute("label-hidden",this.vertical)}render(){return m`
      <div class="parent">
        <div class="children">
          <slot @slotchange=${this.updateChildren}></slot>
        </div>
  ...
  `;let Ce=zr;Qi([v({type:String,reflect:!0})],Ce.prototype,"label",2);Qi([v({type:String,reflect:!0})],Ce.prototype,"icon",2);Qi([v({type:Boolean,reflect:!0})],Ce.prototype,"vertical",1);Qi([v({type:Boolean,attribute:"label-hidden",reflect:!0})],Ce.prototype,"labelHidden",1);var Du=Object.defineProperty,Hu=Object.getOwnPropertyDescriptor,qn=(e,t,i,n)=>{for(var o=n>1?void 0:n?Hu(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Du(t,i,o),o};const jr=class extends T{constructor(){super(...arguments),this.labelsHidden=!1,this._vertical=!1,this._hidden=!1}set vertical(e){this._vertical=e,this.updateSections()}get vertical(){return this._vertical}set hidden(e){this._hidden=e,this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}updateSections(){const e=this.children;for(const t of e)t instanceof Ce&&(t.labelHidden=this.vertical&&!Z.config.sectionLabelOnVerticalToolbar,t.vertical=this.vertical)}render(){return m`
      <div class="parent">
  ...
  `;let Zi=jr;qn([v({type:String,reflect:!0})],Zi.prototype,"icon",2);qn([v({type:Boolean,attribute:"labels-hidden",reflect:!0})],Zi.prototype,"labelsHidden",2);qn([v({type:Boolean,reflect:!0})],Zi.prototype,"vertical",1);var Fu=Object.defineProperty,Bu=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&Fu(t,i,o),o};const Dr=class extends T{constructor(){super(),this._onResize=new Event("resize"),new ResizeObserver(()=>{setTimeout(()=>{this.dispatchEvent(this._onResize)})}).observe(this)}render(){return m`
      <div class="parent">
        <slot></slot>
      </div>
    `}};Dr.styles=P`
 ...
 */const Fr="important",Uu=" !"+Fr,Ft=Ds(class extends Hs{constructor(e){var t;if(super(e),e.type!==js.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const n=e[i];return n==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const n of this.ft)t[n]==null&&(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in t){const o=t[n];if(o!=null){this.ft.add(n);const s=typeof o=="string"&&o.endsWith(Uu);n.includes("-")||s?i.setProperty(n,s?o.slice(0,-11):o,s?Fr:""):i[n]=o}}return qt}}),Vu=e=>{const{components:t}=e,i=t.get(ss);return m`
    ...
    ></bim-button>
  `},qu=e=>j.create(Vu,e),Wu=Object.freeze(Object.defineProperty({__proto__:null,loadIfc:qu},Symbol.toStringTag,{value:"Module"}));({...Wu});const Yu=e=>{const{components:t,actions:i,tags:n}=e,o=(i==null?void 0:i.dispose)??!0,s=(i==null?void 0:i.download)??!0,r=(i==null?void 0:i.visibility)??!0,a=(n==null?void 0:n.schema)??!0,l=(n==null?void 0:n.viewDefinition)??!0,u=t.get(Yt),d=({detail:c})=>{const{cell:h}=c;h.style.padding="0.25rem 0"};return m`
  ...
  `},Gu=(e,t=!0)=>{const i=j.create(Yu,e);if(t){const{components:n}=e,o=n.get(Yt),[,s]=i;o.onFragmentsLoaded.add(()=>setTimeout(()=>s())),o.onFragmentsDisposed.add(()=>s())}return i},Xu=Object.freeze(Object.defineProperty({__proto__:null,modelsList:Gu},Symbol.toStringTag,{value:"Module"})),Br=["Name","ContainedInStructure","ForLayerSet","LayerThickness","HasProperties","HasAssociations","HasAssignments","HasPropertySets","PredefinedType","Quantities","ReferencedSource","Identification",e=>e.includes("Value"),e=>e.startsWith("Material"),e=>e.startsWith("Relating"),e=>{const t=["IsGroupedBy","IsDecomposedBy"];return e.startsWith("Is")&&!t.includes(e)}];async function _i(e,t,i,n=Br,o=!1){const s=e.get(mt),r=await t.getProperties(i);if(!r)return{data:{Entity:`${i} properties not found...`}};const a=s.relationMaps[t.uuid],l={data:{}};for(const u in r){const d=n.map(h=>typeof h=="string"?u===h:h(u)).includes(!0);if(!(u==="type"||d))continue;const c=r[u];if(c)if(c.type===5){l.children||(l.children=[]);const h=await _i(e,t,c.value,n,o);l.children.push(h)}else if(typeof c=="object"&&!Array.isArray(c)){const{value:h,type:p}=c;if(o)p===1||p===2||p===3||(l.data[u]=h);else{const b=typeof h=="number"?Number(h.toFixed(3)):h;l.data[u]=b}}else if(Array.isArray(c))for(const h of c){if(h.type!==5)continue;l.children||(l.children=[]);const p=await _i(e,t,h.value,n,o);l.children.push(p)}else if(u==="type"){const h=xi[c];l.data.Entity=h}else l.data[u]=c}if(a&&a.get(r.expressID)){const u=a.get(r.expressID);for(const d of n){const c=[];if(typeof d=="string"){const h=s._inverseAttributes.indexOf(d);h!==-1&&c.push(h)}else{const h=s._inverseAttributes.filter(p=>d(p));for(const p of h){const b=s._inverseAttributes.indexOf(p);c.push(b)}}for(const h of c){const p=u.get(h);if(p)for(const b of p){const y=await _i(e,t,b,n,o);l.children||(l.children=[]),l.children.push(y)}}}}return l}const Ju=e=>{const{components:t,fragmentIdMap:i,attributesToInclude:n,editable:o,tableDefinition:s}=e,r=t.get(Yt);let a;return typeof n=="function"?a=n(Br):a=n,m`<bim-table ${W(async l=>{if(!l)return;const u=l,d=[],c=[];for(const h in i){const p=r.list.get(h);if(!(p&&p.group))continue;const b=p.group,y=c.find(g=>g.model===b);if(y)for(const g of i[h])y.expressIDs.add(g);else{const g={model:b,expressIDs:new Set(i[h])};c.push(g)}}for(const h of c){const{model:p,expressIDs:b}=h;for(const y of b){const g=await _i(t,p,y,a,o);d.push(g)}}u.dataTransform=s,u.data=d,u.columns=[{name:"Entity",width:"minmax(15rem, 1fr)"}]})}></bim-table>`},Qu=e=>j.create(Ju,e),Zu=Object.freeze(Object.defineProperty({__proto__:null,entityAttributes:Qu},Symbol.toStringTag,{value:"Module"}));let wt;const Ku=e=>{const{components:t,classifications:i}=e,n=t.get(xa),o=t.get(rs);wt||(wt=document.createElement("bim-table"),wt.headersHidden=!0,wt.hiddenColumns=["system"],wt.columns=["Name",{name:"Actions",width:"auto"}],wt.dataTransform={Actions:(r,a)=>{const{system:l,Name:u}=a;if(!(typeof l=="string"&&typeof u=="string"))return r;const d=n.list[l];if(!(d&&d[u]))return r;const c=d[u],{map:h}=c;return m`
          <div>
            <bim-checkbox checked @change=${p=>{const b=p.target;o.set(b.value,h)}}></bim-checkbox>
          </div>
        `}});const s=[];for(const r of i){const a=typeof r=="string"?r:r.system,l=typeof r=="string"?r:r.label,u=n.list[a];u&&s.push({data:{Name:l,system:a},children:Object.keys(u).map(d=>({data:{Name:d,system:a,Actions:""}}))})}return wt.data=s,m`${wt}`},td=(e,t=!0)=>{const i=j.create(Ku,e);if(t){const{components:n}=e,o=n.get(Yt),[,s]=i;o.onFragmentsDisposed.add(()=>s())}return i},ed=Object.freeze(Object.defineProperty({__proto__:null,classificationTree:td},Symbol.toStringTag,{value:"Module"})),Ur=async(e,t,i)=>{var n,o,s,r;const a=e.get(mt),l={data:{Name:(n=i.Name)==null?void 0:n.value},children:[{data:{Name:"Identification",Value:(o=i.Identification)==null?void 0:o.value}},{data:{Name:"Name",Value:(s=i.Name)==null?void 0:s.value}},{data:{Name:"Description",Value:(r=i.Description)==null?void 0:r.value}}]},u=a.getEntityRelations(t,i.expressID,"IsNestedBy");if(!u)return l;l.children||(l.children=[]);const d=[];l.children.push({data:{Name:"Tasks"},children:d});for(const c of u){const h=await t.getProperties(c);if(!h)continue;const p=await Ur(e,t,h);d.push(p)}return l},id=async(e,t,i)=>{const n=[];for(const o of i){const s=await Ur(e,t,o);n.push(s)}return{data:{Name:"Tasks"},children:n}},nd=async(e,t)=>{var i,n,o,s;const r={data:{Name:"Classifications"}};for(const a of t){const{value:l}=a.ReferencedSource,u=await e.getProperties(l);if(!u)continue;const d={data:{Name:(i=u.Name)==null?void 0:i.value},children:[{data:{Name:"Identification",Value:((n=a.Identification)==null?void 0:n.value)||((o=a.ItemReference)==null?void 0:o.value)}},{data:{Name:"Name",Value:(s=a.Name)==null?void 0:s.value}}]};r.children||(r.children=[]),r.children.push(d)}return r},od=async(e,t)=>{var i,n,o,s,r,a;const l={data:{Name:"Materials"}};for(const u of t){if(u.type===cs){const d=(i=u.ForLayerSet)==null?void 0:i.value,c=await e.getProperties(d);if(!c)continue;for(const h of c.MaterialLayers){const{value:p}=h,b=await e.getProperties(p);if(!b)continue;const y=await e.getProperties((n=b.Material)==null?void 0:n.value);if(!y)continue;const g={data:{Name:"Layer"},children:[{data:{Name:"Thickness",Value:(o=b.LayerThickness)==null?void 0:o.value}},{data:{Name:"Material",Value:(s=y.Name)==null?void 0:s.value}}]};l.children||(l.children=[]),l.children.push(g)}}if(u.type===ds)for(const d of u.Materials){const{value:c}=d,h=await e.getProperties(c);if(!h)continue;const p={data:{Name:"Name",Value:(r=h.Name)==null?void 0:r.value}};l.children||(l.children=[]),l.children.push(p)}if(u.type===us){const d={data:{Name:"Name",Value:(a=u.Name)==null?void 0:a.value}};l.children||(l.children=[]),l.children.push(d)}}return l},sd={IFCLENGTHMEASURE:"LENGTHUNIT",IFCAREAMEASURE:"AREAUNIT",IFCVOLUMEMEASURE:"VOLUMEUNIT",IFCPLANEANGLEMEASURE:"PLANEANGLEUNIT"},rd={MILLIMETRE:{symbol:"mm",digits:0},METRE:{symbol:"m",digits:2},KILOMETRE:{symbol:"km",digits:2},SQUARE_METRE:{symbol:"m²",digits:2},CUBIC_METRE:{symbol:"m³",digits:2},DEGREE:{symbol:"°",digits:2},RADIAN:{symbol:"rad",digits:2},GRAM:{symbol:"g",digits:0},KILOGRAM:{symbol:"kg",digits:2},MILLISECOND:{symbol:"ms",digits:0},SECOND:{symbol:"s",digits:0}},Vr=async(e,t)=>{var i,n,o;const s=Object.values(await e.getAllPropertiesOfType(Ia))[0];let r;for(const a of s.Units){const l=await e.getProperties(a.value);if(l&&((i=l.UnitType)==null?void 0:i.value)===sd[t]){r=`${((n=l.Prefix)==null?void 0:n.value)??""}${((o=l.Name)==null?void 0:o.value)??""}`;break}}return r?rd[r]:null},ad=async(e,t,i)=>{var n,o;const{displayUnits:s}=i,r={data:{Name:"PropertySets"}};for(const a of t){const l={data:{Name:(n=a.Name)==null?void 0:n.value}};if(a.type===as){for(const u of a.HasProperties){const{value:d}=u,c=await e.getProperties(d);if(!c)continue;const h=Object.keys(c).find(g=>g.includes("Value"));if(!(h&&c[h]))continue;let p=c[h].value,b="";if(s){const{name:g}=c[h],f=await Vr(e,g)??{};b=f.symbol,p=c[h].value,typeof p=="number"&&f.digits&&(p=p.toFixed(f.digits))}const y={data:{Name:(o=c.Name)==null?void 0:o.value,Value:`${p} ${b??""}`}};l.children||(l.children=[]),l.children.push(y)}l.children&&(r.children||(r.children=[]),r.children.push(l))}}return r},ld=async(e,t,i)=>{var n,o;const{displayUnits:s}=i,r={data:{Name:"QuantitySets"}};for(const a of t){const l={data:{Name:(n=a.Name)==null?void 0:n.value}};if(a.type===ls){for(const u of a.Quantities){const{value:d}=u,c=await e.getProperties(d);if(!c)continue;const h=Object.keys(c).find(g=>g.includes("Value"));if(!(h&&c[h]))continue;let p=c[h].value,b="";if(s){const{name:g}=c[h],f=await Vr(e,g)??{};b=f.symbol,p=c[h].value,typeof p=="number"&&f.digits&&(p=p.toFixed(f.digits))}const y={data:{Name:(o=c.Name)==null?void 0:o.value,Value:`${p} ${b??""}`}};l.children||(l.children=[]),l.children.push(y)}l.children&&(r.children||(r.children=[]),r.children.push(l))}}return r},cd=["OwnerHistory","ObjectPlacement","CompositionType"],qr=async(e,t)=>{const i={groupName:"Attributes",includeClass:!1,...t},{groupName:n,includeClass:o}=i,s={data:{Name:n}};o&&(s.children||(s.children=[]),s.children.push({data:{Name:"Class",Value:xi[e.type]}}));for(const r in e){if(cd.includes(r))continue;const a=e[r];if(a&&typeof a=="object"&&!Array.isArray(a)){if(a.type===Sa)continue;const l={data:{Name:r,Value:a.value}};s.children||(s.children=[]),s.children.push(l)}}return s},de=(e,...t)=>{e.children||(e.children=[]),e.children.push(...t)},ud=async(e,t,i,n,o)=>{const s=e.get(mt).getEntityRelations(t,i,"IsDefinedBy");if(s){const r=[],a=[];for(const d of s){const c=await t.getProperties(d);c&&(c.type===as&&r.push(c),c.type===ls&&a.push(c))}const l=await ad(t,r,o);l.children&&de(n,l);const u=await ld(t,a,o);u.children&&de(n,u)}},dd=async(e,t,i,n)=>{const o=e.get(mt).getEntityRelations(t,i,"HasAssociations");if(o){const s=[],r=[];for(const u of o){const d=await t.getProperties(u);d&&(d.type===ka&&s.push(d),(d.type===cs||d.type===Ta||d.type===Oa||d.type===us||d.type===ds)&&r.push(d))}const a=await nd(t,s);a.children&&de(n,a);const l=await od(t,r);l.children&&de(n,l)}},hd=async(e,t,i,n)=>{const o=e.get(mt).getEntityRelations(t,i,"HasAssignments");if(o){const s=[];for(const a of o){const l=await t.getProperties(a);l&&l.type===Pa&&s.push(l)}const r=await id(e,t,s);r.children&&de(n,r)}},pd=async(e,t,i,n)=>{const o=e.get(mt).getEntityRelations(t,i,"ContainedInStructure");if(o&&o[0]){const s=o[0],r=await t.getProperties(s);if(r){const a=await qr(r,{groupName:"SpatialContainer"});de(n,a)}}};let bi={};const md=async(e,t,i)=>{var n;const o=e.get(mt),s=e.get(Yt),r=s.getModelIdMap(t);Object.keys(t).length===0&&(bi={});const a=[];for(const l in r){const u=s.groups.get(l);if(!u)continue;const d=o.relationMaps[u.uuid];if(!d)continue;l in bi||(bi[l]=new Map);const c=bi[l],h=r[l];for(const p of h){let b=c.get(p);if(b){a.push(b);continue}const y=await u.getProperties(p);if(!y)continue;b={data:{Name:(n=y.Name)==null?void 0:n.value}},a.push(b),c.set(p,b);const g=await qr(y,{includeClass:!0});b.children||(b.children=[]),b.children.push(g),d.get(p)&&(await ud(e,u,p,b,i),await dd(e,u,p,b),await hd(e,u,p,b),await pd(e,u,p,b))}}return a},fd=e=>{const t={emptySelectionWarning:!0,...e},{components:i,fragmentIdMap:n,emptySelectionWarning:o}=t;return m`
  ...
  `},bd=e=>j.create(fd,e),gd=Object.freeze(Object.defineProperty({__proto__:null,elementProperties:bd},Symbol.toStringTag,{value:"Module"})),En=async(e,t,i,n)=>{var o;const s=[],r=e.get(mt),a=await t.getProperties(i);if(!a)return s;const{type:l}=a,u={data:{Entity:xi[l],Name:(o=a.Name)==null?void 0:o.value,modelID:t.uuid,expressID:i}};for(const d of n){const c=r.getEntityRelations(t,i,d);if(!c)continue;u.children||(u.children=[]),u.data.relations=JSON.stringify(c);const h={};for(const p of c){const b=await En(e,t,p,n);for(const y of b)if(y.data.relations)u.children.push(y);else{const g=t.data.get(p);if(!g){u.children.push(y);continue}const f=g[1][1],_=xi[f];_ in h||(h[_]=[]),y.data.Entity=y.data.Name,delete y.data.Name,h[_].push(y)}}for(const p in h){const b=h[p],y=b.map(f=>f.data.expressID),g={data:{Entity:p,modelID:t.uuid,relations:JSON.stringify(y)},children:b};u.children.push(g)}}return s.push(u),s},vd=async(e,t,i,n)=>{const o=e.get(mt),s=[];for(const r of t){let a;if(n)a={data:{Entity:r.name!==""?r.name:r.uuid},children:await En(e,r,n,i)};else{const l=o.relationMaps[r.uuid],u=await r.getAllPropertiesOfType(Ea);if(!(l&&u))continue;const{expressID:d}=Object.values(u)[0];a={data:{Entity:r.name!==""?r.name:r.uuid},children:await En(e,r,d,i)}}s.push(a)}return s};let ft;const yd=(e,t)=>{const i=e.get(Yt),{modelID:n,expressID:o,relations:s}=t;if(!n)return null;const r=i.groups.get(n);return r?r.getFragmentMap([o,...JSON.parse(s??"[]")]):null},_d=e=>{const{components:t,models:i,expressID:n}=e,o=e.selectHighlighterName??"select",s=e.hoverHighlighterName??"hover";ft||(ft=document.createElement("bim-table"),ft.hiddenColumns=["modelID","expressID","relations"],ft.columns=["Entity","Name"],ft.headersHidden=!0,ft.addEventListener("cellcreated",({detail:a})=>{const{cell:l}=a;l.column==="Entity"&&!("Name"in l.rowData)&&(l.style.gridColumn="1 / -1")})),ft.addEventListener("rowcreated",a=>{a.stopImmediatePropagation();const{row:l}=a.detail,u=t.get(wa),d=yd(t,l.data);d&&Object.keys(d).length!==0&&(l.onmouseover=()=>{s&&(l.style.backgroundColor="var(--bim-ui_bg-contrast-20)",u.highlightByID(s,d,!0,!1,u.selection[o]??{}))},l.onmouseout=()=>{l.style.backgroundColor="",u.clear(s)},l.onclick=()=>{o&&u.highlightByID(o,d,!0,!0)})});const r=e.inverseAttributes??["IsDecomposedBy","ContainsElements"];return vd(t,i,r,n).then(a=>ft.data=a),m`${ft}`},wd=(e,t=!0)=>{const i=j.create(_d,e);if(t){const[,n]=i,{components:o}=e,s=o.get(Yt),r=o.get(mt),a=()=>n({models:s.groups.values()});r.onRelationsIndexed.add(a),s.onFragmentsDisposed.add(a)}return i},xd=Object.freeze(Object.defineProperty({__proto__:null,relationsTree:wd},Symbol.toStringTag,{value:"Module"})),Oe=(e,t)=>[...e.get(On).list.values()].find(i=>i.world===t),$d=(e,t)=>m`
  ...
  `},Td=(e,t)=>{const{postproduction:i}=e;return m`
...
\f\r]`,Pe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qo=/-->/g,Wo=/>/g,zt=RegExp(`>|${un}(?:([^\\s"'>=/]+)(${un}*=${un}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Yo=/'/g,Go=/"/g,Gr=/^(?:script|style|textarea|title)$/i,Md=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),Yn=Md(1),he=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),Xo=new WeakMap,Dt=Wt.createTreeWalker(Wt,129);function Xr(e,t){if(!Wn(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Vo!==void 0?Vo.createHTML(t):t}const Ld=(e,t)=>{const i=e.length-1,n=[];let o,s=t===2?"<svg>":t===3?"<math>":"",r=Pe;for(let a=0;a<i;a++){const l=e[a];let u,d,c=-1,h=0;for(;h<l.length&&(r.lastIndex=h,d=r.exec(l),d!==null);)h=r.lastIndex,r===Pe?d[1]==="!--"?r=qo:d[1]!==void 0?r=Wo:d[2]!==void 0?(Gr.test(d[2])&&(o=RegExp("</"+d[2],"g")),r=zt):d[3]!==void 0&&(r=zt):r===zt?d[0]===">"?(r=o??Pe,c=-1):d[1]===void 0?c=-2:(c=r.lastIndex-d[2].length,u=d[1],r=d[3]===void 0?zt:d[3]==='"'?Go:Yo):r===Go||r===Yo?r=zt:r===qo||r===Wo?r=Pe:(r=zt,o=void 0);const p=r===zt&&e[a+1].startsWith("/>")?" ":"";s+=r===Pe?l+Nd:c>=0?(n.push(u),l.slice(0,c)+Wr+l.slice(c)+Ct+p):l+Ct+(c===-2?a:p)}return[Xr(e,s+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]};class Ge{constructor({strings:t,_$litType$:i},n){let o;this.parts=[];let s=0,r=0;const a=t.length-1,l=this.parts,[u,d]=Ld(t,i);if(this.el=Ge.createElement(u,n),Dt.currentNode=this.el.content,i===2||i===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(o=Dt.nextNode())!==null&&l.length<a;){if(o.nodeType===1){if(o.hasAttributes())for(const c of o.getAttributeNames())if(c.endsWith(Wr)){const h=d[r++],p=o.getAttribute(c).split(Ct),b=/([.?@])?(.*)/.exec(h);l.push({type:1,index:s,name:b[2],strings:p,ctor:b[1]==="."?jd:b[1]==="?"?Dd:b[1]==="@"?Hd:Ki}),o.removeAttribute(c)}else c.startsWith(Ct)&&(l.push({type:6,index:s}),o.removeAttribute(c));if(Gr.test(o.tagName)){const c=o.textContent.split(Ct),h=c.length-1;if(h>0){o.textContent=Ni?Ni.emptyScript:"";for(let p=0;p<h;p++)o.append(c[p],We()),Dt.nextNode(),l.push({type:2,index:++s});o.append(c[h],We())}}}else if(o.nodeType===8)if(o.data===Yr)l.push({type:2,index:s});else{let c=-1;for(;(c=o.data.indexOf(Ct,c+1))!==-1;)l.push({type:7,index:s}),c+=Ct.length-1}s++}}static createElement(t,i){const n=Wt.createElement("template");return n.innerHTML=t,n}}function pe(e,t,i=e,n){var o,s;if(t===he)return t;let r=n!==void 0?(o=i._$Co)==null?void 0:o[n]:i._$Cl;const a=Ye(t)?void 0:t._$litDirective$;return(r==null?void 0:r.constructor)!==a&&((s=r==null?void 0:r._$AO)==null||s.call(r,!1),a===void 0?r=void 0:(r=new a(e),r._$AT(e,i,n)),n!==void 0?(i._$Co??(i._$Co=[]))[n]=r:i._$Cl=r),r!==void 0&&(t=pe(e,r._$AS(e,t.values),r,n)),t}class zd{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:n}=this._$AD,o=((t==null?void 0:t.creationScope)??Wt).importNode(i,!0);Dt.currentNode=o;let s=Dt.nextNode(),r=0,a=0,l=n[0];for(;l!==void 0;){if(r===l.index){let u;l.type===2?u=new ci(s,s.nextSibling,this,t):l.type===1?u=new l.ctor(s,l.name,l.strings,this,t):l.type===6&&(u=new Fd(s,this,t)),this._$AV.push(u),l=n[++a]}r!==(l==null?void 0:l.index)&&(s=Dt.nextNode(),r++)}return Dt.currentNode=Wt,o}p(t){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,i),i+=n.strings.length-2):n._$AI(t[i])),i++}}class ci{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,i,n,o){this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=n,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=pe(this,t,i),Ye(t)?t===z||t==null||t===""?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==he&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Rd(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==z&&Ye(this._$AH)?this._$AA.nextSibling.data=t:this.T(Wt.createTextNode(t)),this._$AH=t}$(t){var i;const{values:n,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Ge.createElement(Xr(o.h,o.h[0]),this.options)),o);if(((i=this._$AH)==null?void 0:i._$AD)===s)this._$AH.p(n);else{const r=new zd(s,this),a=r.u(this.options);r.p(n),this.T(a),this._$AH=r}}_$AC(t){let i=Xo.get(t.strings);return i===void 0&&Xo.set(t.strings,i=new Ge(t)),i}k(t){Wn(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,o=0;for(const s of t)o===i.length?i.push(n=new ci(this.O(We()),this.O(We()),this,this.options)):n=i[o],n._$AI(s),o++;o<i.length&&(this._$AR(n&&n._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,i);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var i;this._$AM===void 0&&(this._$Cv=t,(i=this._$AP)==null||i.call(this,t))}}class Ki{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,n,o,s){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=z}_$AI(t,i=this,n,o){const s=this.strings;let r=!1;if(s===void 0)t=pe(this,t,i,0),r=!Ye(t)||t!==this._$AH&&t!==he,r&&(this._$AH=t);else{const a=t;let l,u;for(t=s[0],l=0;l<s.length-1;l++)u=pe(this,a[n+l],i,l),u===he&&(u=this._$AH[l]),r||(r=!Ye(u)||u!==this._$AH[l]),u===z?t=z:t!==z&&(t+=(u??"")+s[l+1]),this._$AH[l]=u}r&&!o&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class jd extends Ki{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}}class Dd extends Ki{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==z)}}class Hd extends Ki{constructor(t,i,n,o,s){super(t,i,n,o,s),this.type=5}_$AI(t,i=this){if((t=pe(this,t,i,0)??z)===he)return;const n=this._$AH,o=t===z&&n!==z||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,s=t!==z&&(n===z||o);o&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,t):this._$AH.handleEvent(t)}}class Fd{constructor(t,i,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){pe(this,t)}}const Jo=Ii.litHtmlPolyfillSupport;Jo==null||Jo(Ge,ci),(Ii.litHtmlVersions??(Ii.litHtmlVersions=[])).push("3.2.1");const Bd=(e,t,i)=>{const n=(i==null?void 0:i.renderBefore)??t;let o=n._$litPart$;if(o===void 0){const s=(i==null?void 0:i.renderBefore)??null;n._$litPart$=o=new ci(t.insertBefore(We(),s),s,void 0,i??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Sn=()=>new Qd;let Qd=class{};const dn=new WeakMap,Zd=qd(class extends Jd{render(e){return z}update(e,[t]){var i;const n=t!==this.Y;return n&&this.Y!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.Y=t,this.ht=(i=e.options)==null?void 0:i.host,this.rt(this.ct=e.element)),z}rt(e){if(this.isConnected||(e=void 0),typeof this.Y=="function"){const t=this.ht??globalThis;let i=dn.get(t);i===void 0&&(i=new WeakMap,dn.set(t,i)),i.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),i.set(this.Y,e),e!==void 0&&this.Y.call(this.ht,e)}else this.Y.value=e}get lt(){var e,t;return typeof this.Y=="function"?(e=dn.get(this.ht??globalThis))==null?void 0:e.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Kd={dueDate:e=>{if(typeof e=="string"&&e.trim()!=="")return new Date(e)},status:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},type:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},priority:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},stage:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},assignedTo:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},labels:e=>{if(Array.isArray(e))return new Set(e)}},Qr=e=>{const{components:t,topic:i,value:n,onCancel:o,onSubmit:s,styles:r}=e,a=s??(()=>{}),l=t.get(Je),u=(n==null?void 0:n.title)??(i==null?void 0:i.title)??_t.default.title,d=(n==null?void 0:n.status)??(i==null?void 0:i.status)??_t.default.status,c=(n==null?void 0:n.type)??(i==null?void 0:i.type)??_t.default.type,h=(n==null?void 0:n.priority)??(i==null?void 0:i.priority)??_t.default.priority,p=(n==null?void 0:n.assignedTo)??(i==null?void 0:i.assignedTo)??_t.default.assignedTo,b=(n==null?void 0:n.labels)??(i==null?void 0:i.labels)??_t.default.labels,y=(n==null?void 0:n.stage)??(i==null?void 0:i.stage)??_t.default.stage,g=(n==null?void 0:n.description)??(i==null?void 0:i.description)??_t.default.description,f=i!=null&&i.dueDate?i.dueDate.toISOString().split("T")[0]:null,_=new Set([...l.config.statuses]);d&&_.add(d);const w=new Set([...l.config.types]);c&&w.add(c);const x=new Set([...l.config.priorities]);h&&x.add(h);const A=new Set([...l.config.users]);p&&A.add(p);const C=new Set([...l.config.labels]);if(b)for(const $ of b)C.add($);const O=new Set([...l.config.stages]);y&&O.add(y);const N=Sn(),S=async()=>{const{value:$}=N;if(!$)return;const L=qe($,Kd);if(i)i.set(L),await a(i);else{const V=l.create(L);await a(V)}},E=Sn(),B=$=>{const{value:L}=E;if(!L)return;const V=$.target;L.disabled=V.value.trim()===""},Y=`btn-${Z.newRandomId()}`,q=`btn-${Z.newRandomId()}`;return m`
  ...
  `},Zr=(e,t=!0)=>{const i=j.create(th,e);if(t){const{components:n,topics:o}=e,[,s]=i,r=n.get(Je);if(r.list.onItemUpdated.add(()=>s()),r.list.onItemDeleted.add(()=>s()),o)for(const a of o)a.relatedTopics.onItemAdded.add(()=>s()),a.relatedTopics.onItemDeleted.add(()=>s()),a.relatedTopics.onCleared.add(()=>s());else r.list.onItemSet.add(()=>s())}return i},eh=Object.freeze(Object.defineProperty({__proto__:null,topicsList:Zr},Symbol.toStringTag,{value:"Module"})),ih=e=>{const{topic:t,styles:i,viewpoint:n}=e,o={delete:!0,...e.actions};return m`
  ...
  `},hh=e=>j.create(dh,e),ph=Object.freeze(Object.defineProperty({__proto__:null,topicInformation:hh},Symbol.toStringTag,{value:"Module"})),mh=(e,t)=>{const{showInput:i,topic:n,styles:o}=e,s={add:!0,delete:!0,...e.actions},r=`input-${Z.newRandomId()}`,a=`btn-${Z.newRandomId()}`,l=`btn-${Z.newRandomId()}`,u=()=>document.getElementById(a),d=()=>document.getElementById(r),c=()=>{const w=d();return w?w.value.trim().length>0:!1},h=()=>{t({showInput:!0})},p=()=>{const w=d(),x=c();w&&x&&(n.createComment(w.value),t({showInput:!1}))},b=()=>{t({showInput:!1})},y=()=>{const w=u();if(w){if(!d()){w.disabled=!0;return}w.disabled=!c()}},g=m`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ih={attribute:!0,type:String,converter:Mi,reflect:!1,hasChanged:Qn},Nh=(e=Ih,t,i)=>{const{kind:n,metadata:o}=i;let s=globalThis.litPropertyMetadata.get(o);if(s===void 0&&globalThis.litPropertyMetadata.set(o,s=new Map),s.set(i.name,e),n==="accessor"){const{name:r}=i;return{set(a){const l=t.get.call(this);t.set.call(this,a),this.requestUpdate(r,l,e)},init(a){return a!==void 0&&this.P(r,void 0,e),a}}}if(n==="setter"){const{name:r}=i;return function(a){const l=this[r];t.call(this,a),this.requestUpdate(r,l,e)}}throw Error("Unsupported decorator location: "+n)};function G(e){return(t,i)=>typeof i=="object"?Nh(e,t,i):((n,o,s)=>{const r=o.hasOwnProperty(s);return o.constructor.createProperty(s,r?{...n,wrapped:!0}:n),r?Object.getOwnPropertyDescriptor(o,s):void 0})(e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Rh(e){return G({...e,state:!0,attribute:!1})}class Mh extends Ca{constructor(t=document.createElement("div")){super(),this.isCSS2DObject=!0,this.element=t,this.element.style.position="absolute",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.center=new Aa(.5,.5),this.addEventListener("removed",function(){this.traverse(function(i){i.element instanceof Element&&i.element.parentNode!==null&&i.element.parentNode.removeChild(i.element)})})}copy(t,i){return super.copy(t,i),this.element=t.element.cloneNode(!0),this.center=t.center,this}}new kn;new ji;new ji;new kn;new kn;class Lh{constructor(t,i){this._group=new eo,this._frustum=new ma,this._frustumMat=new ji,this._regenerateDelay=200,this._regenerateCounter=0,this.material=new fa({color:"#2e3338"}),this.numbers=new eo,this.maxRegenerateRetrys=4,this.gridsFactor=5,this._scaleX=1,this._scaleY=1,this._offsetX=0,this._offsetY=0,this._camera=t,this._container=i;const n=this.newGrid(-1),o=this.newGrid(-2);this.grids={main:n,secondary:o},this._group.add(o,n,this.numbers)}set scaleX(t){this._scaleX=t,this.regenerate()}get scaleX(){return this._scaleX}set scaleY(t){this._scaleY=t,this.regenerate()}get scaleY(){return this._scaleY}set offsetX(t){this._offsetX=t,this.regenerate()}get offsetX(){return this._offsetX}set offsetY(t){this._offsetY=t,this.regenerate()}get offsetY(){return this._offsetY}get(){return this._group}dispose(){const{main:t,secondary:i}=this.grids;t.removeFromParent(),i.removeFromParent(),t.geometry.dispose(),t.material.dispose(),i.geometry.dispose(),i.material.dispose()}regenerate(){if(!this.isGridReady()){if(this._regenerateCounter++,this._regenerateCounter>this.maxRegenerateRetrys)throw new Error("Grid could not be regenerated");setTimeout(()=>this.regenerate,this._regenerateDelay);return}this._regenerateCounter=0,this._camera.updateMatrix(),this._camera.updateMatrixWorld();const t=this._frustumMat.multiplyMatrices(this._camera.projectionMatrix,this._camera.matrixWorldInverse);this._frustum.setFromProjectionMatrix(t);const{planes:i}=this._frustum,n=i[0].constant*-i[0].normal.x,o=i[1].constant*-i[1].normal.x,s=i[2].constant*-i[2].normal.y,r=i[3].constant*-i[3].normal.y,a=Math.abs(n-o),l=Math.abs(r-s),{clientWidth:u,clientHeight:d}=this._container,c=Math.max(u,d),h=Math.max(a,l)/c,p=Math.ceil(Math.log10(a/this.scaleX)),b=Math.ceil(Math.log10(l/this.scaleY)),y=10**(p-2)*this.scaleX,g=10**(b-2)*this.scaleY,f=y*this.gridsFactor,_=g*this.gridsFactor,w=Math.ceil(l/_),x=Math.ceil(a/f),A=Math.ceil(l/g),C=Math.ceil(a/y),O=y*Math.ceil(o/y),N=g*Math.ceil(s/g),S=f*Math.ceil(o/f),E=_*Math.ceil(s/_),B=[...this.numbers.children];for(const U of B)U.removeFromParent();this.numbers.children=[];const Y=[],q=9*h,$=1e4,L=S+this._offsetX,V=Math.round(Math.abs(L/this.scaleX)*$)/$,tt=(x-1)*f,et=Math.round(Math.abs((L+tt)/this.scaleX)*$)/$,ut=Math.max(V,et).toString().length*q;let Ae=Math.ceil(ut/f)*f;for(let U=0;U<x;U++){let D=S+U*f;Y.push(D,r,0,D,s,0),D=Math.round(D*$)/$,Ae=Math.round(Ae*$)/$;const Ee=D%Ae;if(!(f<1||_<1)&&Math.abs(Ee)>.01)continue;const hi=this.newNumber((D+this._offsetX)/this.scaleX),nn=12*h;hi.position.set(D,s+nn,0)}for(let U=0;U<w;U++){const D=E+U*_;Y.push(o,D,0,n,D,0);const Ee=this.newNumber(D/this.scaleY);let hi=12;Ee.element.textContent&&(hi+=4*Ee.element.textContent.length);const nn=hi*h;Ee.position.set(o+nn,D,0)}const en=[];for(let U=0;U<C;U++){const D=O+U*y;en.push(D,r,0,D,s,0)}for(let U=0;U<A;U++){const D=N+U*g;en.push(o,D,0,n,D,0)}const ca=new io(new Float32Array(Y),3),ua=new io(new Float32Array(en),3),{main:da,secondary:ha}=this.grids;da.geometry.setAttribute("position",ca),ha.geometry.setAttribute("position",ua)}newNumber(t){const i=document.createElement("bim-label");i.textContent=String(Math.round(t*100)/100);const n=new Mh(i);return this.numbers.add(n),n}newGrid(t){const i=new ba,n=new ga(i,this.material);return n.frustumCulled=!1,n.renderOrder=t,n}isGridReady(){const t=this._camera.projectionMatrix.elements;for(let i=0;i<t.length;i++){const n=t[i];if(Number.isNaN(n))return!1}return!0}}var zh=Object.defineProperty,jh=Object.getOwnPropertyDescriptor,ui=(e,t,i,n)=>{for(var o=jh(t,i),s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&zh(t,i,o),o};const ia=class extends Bt{constructor(){super(...arguments),this._grid=null,this._world=null,this.resize=()=>{this._world&&this._grid&&this._grid.regenerate()}}set gridColor(t){if(this._gridColor=t,!(t&&this._grid))return;const i=Number(t.replace("#","0x"));Number.isNaN(i)||this._grid.material.color.setHex(i)}get gridColor(){return this._gridColor}set gridScaleX(t){this._gridScaleX=t,t&&this._grid&&(this._grid.scaleX=t)}get gridScaleX(){return this._gridScaleX}set gridScaleY(t){this._gridScaleY=t,t&&this._grid&&(this._grid.scaleY=t)}get gridScaleY(){return this._gridScaleY}get gridOffsetX(){var t;return((t=this._grid)==null?void 0:t.offsetX)||0}set gridOffsetX(t){this._grid&&(this._grid.offsetX=t)}get gridOffsetY(){var t;return((t=this._grid)==null?void 0:t.offsetY)||0}set gridOffsetY(t){this._grid&&(this._grid.offsetY=t)}set components(t){this.dispose();const i=t.get(Xe).create();this._world=i,i.scene=new Tn(t),i.scene.setup(),i.renderer=new pa(t,this);const n=new os(t);i.camera=n;const o=new Lh(n.threeOrtho,this);this._grid=o,i.scene.three.add(o.get()),n.controls.addEventListener("update",()=>o.regenerate()),setTimeout(async()=>{i.camera.updateAspect(),n.set("Plan"),await n.controls.setLookAt(0,0,100,0,0,0),await n.projection.set("Orthographic"),n.controls.dollySpeed=3,n.controls.draggingSmoothTime=.085,n.controls.maxZoom=1e3,n.controls.zoom(4)})}get world(){return this._world}dispose(){var t;(t=this.world)==null||t.dispose(),this._world=null,this._grid=null}connectedCallback(){super.connectedCallback(),new ResizeObserver(this.resize).observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.dispose()}render(){return Yn`<slot></slot>`}};ia.styles=Jn`
  ...
  `;let di=ia;ui([G({type:String,attribute:"grid-color",reflect:!0})],di.prototype,"gridColor");ui([G({type:Number,attribute:"grid-scale-x",reflect:!0})],di.prototype,"gridScaleX");ui([G({type:Number,attribute:"grid-scale-y",reflect:!0})],di.prototype,"gridScaleY");ui([G({type:Number,attribute:"grid-offset-x",reflect:!0})],di.prototype,"gridOffsetX");ui([G({type:Number,attribute:"grid-offset-y",reflect:!0})],di.prototype,"gridOffsetY");var Dh=Object.defineProperty,Nt=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&Dh(t,i,o),o};const na=class extends Bt{constructor(){super(...arguments),this._defaults={size:60},this._cssMatrix3D="",this._matrix=new ji,this._onRightClick=new Event("rightclick"),this._onLeftClick=new Event("leftclick"),this._onTopClick=new Event("topclick"),this._onBottomClick=new Event("bottomclick"),this._onFrontClick=new Event("frontclick"),this._onBackClick=new Event("backclick"),this._camera=null,this._epsilon=t=>Math.abs(t)<1e-10?0:t}set camera(t){this._camera=t,this.updateOrientation()}get camera(){return this._camera}updateOrientation(){if(!this.camera)return;this._matrix.extractRotation(this.camera.matrixWorldInverse);const{elements:t}=this._matrix;this._cssMatrix3D=`matrix3d(
      ${this._epsilon(t[0])},
      ${this._epsilon(-t[1])},
      ${this._epsilon(t[2])},
      ${this._epsilon(t[3])},
  ...
  `);Zh({onCancel:()=>{zi.close()},onSubmit:()=>{zi.close()}});const[tp,la]=Qe.create(e=>{const{components:t,topic:i,world:n,actions:o,styles:s}=e;let r,a;if(i){const[l]=gi.topicInformation({components:t,topic:i,actions:o==null?void 0:o.information,styles:s}),[u]=gi.topicViewpoints({components:t,topic:i,world:n,actions:o==null?void 0:o.viewpoints}),[d]=gi.topicRelations({components:t,topic:i,actions:o==null?void 0:o.relatedTopics}),[c]=gi.topicComments({topic:i,actions:o==null?void 0:o.comments,styles:s==null?void 0:s.users}),h=()=>{window.alert(`An email will be sent to ${i.assignedTo}! (obviosuly not, this is just for demo purposes)`)};r=dt`
