var Vn=Object.defineProperty;var Yn=(i,t,e)=>t in i?Vn(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var rt=(i,t,e)=>(Yn(i,typeof t!="symbol"?t+"":t,e),e);import{i as C,r as S,n as d,a as Lt}from"./state-VyZkHw6A.js";import{B as Ht,x as m,E as Wn}from"./lit-html-CuBe1DX_.js";import{e as kt,n as Et}from"./ref-DfidMTJ6.js";const At=Math.min,X=Math.max,re=Math.round,ot=i=>({x:i,y:i}),Qn={left:"right",right:"left",bottom:"top",top:"bottom"},Un={start:"end",end:"start"};function $i(i,t,e){return X(i,At(t,e))}function Qt(i,t){return typeof i=="function"?i(t):i}function K(i){return i.split("-")[0]}function ve(i){return i.split("-")[1]}function Xi(i){return i==="x"?"y":"x"}function Ki(i){return i==="y"?"height":"width"}function xt(i){return["top","bottom"].includes(K(i))?"y":"x"}function Ji(i){return Xi(xt(i))}function Gn(i,t,e){e===void 0&&(e=!1);const s=ve(i),n=Ji(i),r=Ki(n);let o=n==="x"?s===(e?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(o=oe(o)),[o,oe(o)]}function Xn(i){const t=oe(i);return[Ie(i),t,Ie(t)]}function Ie(i){return i.replace(/start|end/g,t=>Un[t])}function Kn(i,t,e){const s=["left","right"],n=["right","left"],r=["top","bottom"],o=["bottom","top"];switch(i){case"top":case"bottom":return e?t?n:s:t?s:n;case"left":case"right":return t?r:o;default:return[]}}function Jn(i,t,e,s){const n=ve(i);let r=Kn(K(i),e==="start",s);return n&&(r=r.map(o=>o+"-"+n),t&&(r=r.concat(r.map(Ie)))),r}function oe(i){return i.replace(/left|right|bottom|top/g,t=>Qn[t])}function Zn(i){return{top:0,right:0,bottom:0,left:0,...i}}function Zi(i){return typeof i!="number"?Zn(i):{top:i,right:i,bottom:i,left:i}}function Pt(i){const{x:t,y:e,width:s,height:n}=i;return{width:s,height:n,top:e,left:t,right:t+s,bottom:e+n,x:t,y:e}}function Si(i,t,e){let{reference:s,floating:n}=i;const r=xt(t),o=Ji(t),a=Ki(o),l=K(t),c=r==="y",u=s.x+s.width/2-n.width/2,h=s.y+s.height/2-n.height/2,f=s[a]/2-n[a]/2;let p;switch(l){case"top":p={x:u,y:s.y-n.height};break;case"bottom":p={x:u,y:s.y+s.height};break;case"right":p={x:s.x+s.width,y:h};break;case"left":p={x:s.x-n.width,y:h};break;default:p={x:s.x,y:s.y}}switch(ve(t)){case"start":p[o]-=f*(e&&c?-1:1);break;case"end":p[o]+=f*(e&&c?-1:1);break}return p}const ts=async(i,t,e)=>{const{placement:s="bottom",strategy:n="absolute",middleware:r=[],platform:o}=e,a=r.filter(Boolean),l=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:i,floating:t,strategy:n}),{x:u,y:h}=Si(c,s,l),f=s,p={},b=0;for(let g=0;g<a.length;g++){const{name:v,fn:k}=a[g],{x:$,y:w,data:_,reset:A}=await k({x:u,y:h,initialPlacement:s,placement:f,strategy:n,middlewareData:p,rects:c,platform:o,elements:{reference:i,floating:t}});u=$??u,h=w??h,p={...p,[v]:{...p[v],..._}},A&&b<=50&&(b++,typeof A=="object"&&(A.placement&&(f=A.placement),A.rects&&(c=A.rects===!0?await o.getElementRects({reference:i,floating:t,strategy:n}):A.rects),{x:u,y:h}=Si(c,f,l)),g=-1)}return{x:u,y:h,placement:f,strategy:n,middlewareData:p}};async function tn(i,t){var e;t===void 0&&(t={});const{x:s,y:n,platform:r,rects:o,elements:a,strategy:l}=i,{boundary:c="clippingAncestors",rootBoundary:u="viewport",elementContext:h="floating",altBoundary:f=!1,padding:p=0}=Qt(t,i),b=Zi(p),v=a[f?h==="floating"?"reference":"floating":h],k=Pt(await r.getClippingRect({element:(e=await(r.isElement==null?void 0:r.isElement(v)))==null||e?v:v.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:u,strategy:l})),$=h==="floating"?{x:s,y:n,width:o.floating.width,height:o.floating.height}:o.reference,w=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),_=await(r.isElement==null?void 0:r.isElement(w))?await(r.getScale==null?void 0:r.getScale(w))||{x:1,y:1}:{x:1,y:1},A=Pt(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:$,offsetParent:w,strategy:l}):$);return{top:(k.top-A.top+b.top)/_.y,bottom:(A.bottom-k.bottom+b.bottom)/_.y,left:(k.left-A.left+b.left)/_.x,right:(A.right-k.right+b.right)/_.x}}const es=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(t){var e,s;const{placement:n,middlewareData:r,rects:o,initialPlacement:a,platform:l,elements:c}=t,{mainAxis:u=!0,crossAxis:h=!0,fallbackPlacements:f,fallbackStrategy:p="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:g=!0,...v}=Qt(i,t);if((e=r.arrow)!=null&&e.alignmentOffset)return{};const k=K(n),$=xt(a),w=K(a)===a,_=await(l.isRTL==null?void 0:l.isRTL(c.floating)),A=f||(w||!g?[oe(a)]:Xn(a)),x=b!=="none";!f&&x&&A.push(...Jn(a,g,b,_));const T=[a,...A],D=await tn(t,v),H=[];let E=((s=r.flip)==null?void 0:s.overflows)||[];if(u&&H.push(D[k]),h){const Y=Gn(n,o,_);H.push(D[Y[0]],D[Y[1]])}if(E=[...E,{placement:n,overflows:H}],!H.every(Y=>Y<=0)){var _t,jt;const Y=(((_t=r.flip)==null?void 0:_t.index)||0)+1,$t=T[Y];if($t)return{data:{index:Y,overflows:E},reset:{placement:$t}};let it=(jt=E.filter(nt=>nt.overflows[0]<=0).sort((nt,W)=>nt.overflows[1]-W.overflows[1])[0])==null?void 0:jt.placement;if(!it)switch(p){case"bestFit":{var Ct;const nt=(Ct=E.filter(W=>{if(x){const st=xt(W.placement);return st===$||st==="y"}return!0}).map(W=>[W.placement,W.overflows.filter(st=>st>0).reduce((st,Nn)=>st+Nn,0)]).sort((W,st)=>W[1]-st[1])[0])==null?void 0:Ct[0];nt&&(it=nt);break}case"initialPlacement":it=a;break}if(n!==it)return{reset:{placement:it}}}return{}}}};function en(i){const t=At(...i.map(r=>r.left)),e=At(...i.map(r=>r.top)),s=X(...i.map(r=>r.right)),n=X(...i.map(r=>r.bottom));return{x:t,y:e,width:s-t,height:n-e}}function is(i){const t=i.slice().sort((n,r)=>n.y-r.y),e=[];let s=null;for(let n=0;n<t.length;n++){const r=t[n];!s||r.y-s.y>s.height/2?e.push([r]):e[e.length-1].push(r),s=r}return e.map(n=>Pt(en(n)))}const ns=function(i){return i===void 0&&(i={}),{name:"inline",options:i,async fn(t){const{placement:e,elements:s,rects:n,platform:r,strategy:o}=t,{padding:a=2,x:l,y:c}=Qt(i,t),u=Array.from(await(r.getClientRects==null?void 0:r.getClientRects(s.reference))||[]),h=is(u),f=Pt(en(u)),p=Zi(a);function b(){if(h.length===2&&h[0].left>h[1].right&&l!=null&&c!=null)return h.find(v=>l>v.left-p.left&&l<v.right+p.right&&c>v.top-p.top&&c<v.bottom+p.bottom)||f;if(h.length>=2){if(xt(e)==="y"){const E=h[0],_t=h[h.length-1],jt=K(e)==="top",Ct=E.top,Y=_t.bottom,$t=jt?E.left:_t.left,it=jt?E.right:_t.right,nt=it-$t,W=Y-Ct;return{top:Ct,bottom:Y,left:$t,right:it,width:nt,height:W,x:$t,y:Ct}}const v=K(e)==="left",k=X(...h.map(E=>E.right)),$=At(...h.map(E=>E.left)),w=h.filter(E=>v?E.left===$:E.right===k),_=w[0].top,A=w[w.length-1].bottom,x=$,T=k,D=T-x,H=A-_;return{top:_,bottom:A,left:x,right:T,width:D,height:H,x,y:_}}return f}const g=await r.getElementRects({reference:{getBoundingClientRect:b},floating:s.floating,strategy:o});return n.reference.x!==g.reference.x||n.reference.y!==g.reference.y||n.reference.width!==g.reference.width||n.reference.height!==g.reference.height?{reset:{rects:g}}:{}}}};async function ss(i,t){const{placement:e,platform:s,elements:n}=i,r=await(s.isRTL==null?void 0:s.isRTL(n.floating)),o=K(e),a=ve(e),l=xt(e)==="y",c=["left","top"].includes(o)?-1:1,u=r&&l?-1:1,h=Qt(t,i);let{mainAxis:f,crossAxis:p,alignmentAxis:b}=typeof h=="number"?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:h.mainAxis||0,crossAxis:h.crossAxis||0,alignmentAxis:h.alignmentAxis};return a&&typeof b=="number"&&(p=a==="end"?b*-1:b),l?{x:p*u,y:f*c}:{x:f*c,y:p*u}}const nn=function(i){return{name:"offset",options:i,async fn(t){var e,s;const{x:n,y:r,placement:o,middlewareData:a}=t,l=await ss(t,i);return o===((e=a.offset)==null?void 0:e.placement)&&(s=a.arrow)!=null&&s.alignmentOffset?{}:{x:n+l.x,y:r+l.y,data:{...l,placement:o}}}}},rs=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(t){const{x:e,y:s,placement:n}=t,{mainAxis:r=!0,crossAxis:o=!1,limiter:a={fn:v=>{let{x:k,y:$}=v;return{x:k,y:$}}},...l}=Qt(i,t),c={x:e,y:s},u=await tn(t,l),h=xt(K(n)),f=Xi(h);let p=c[f],b=c[h];if(r){const v=f==="y"?"top":"left",k=f==="y"?"bottom":"right",$=p+u[v],w=p-u[k];p=$i($,p,w)}if(o){const v=h==="y"?"top":"left",k=h==="y"?"bottom":"right",$=b+u[v],w=b-u[k];b=$i($,b,w)}const g=a.fn({...t,[f]:p,[h]:b});return{...g,data:{x:g.x-e,y:g.y-s,enabled:{[f]:r,[h]:o}}}}}};function ye(){return typeof window<"u"}function at(i){return sn(i)?(i.nodeName||"").toLowerCase():"#document"}function R(i){var t;return(i==null||(t=i.ownerDocument)==null?void 0:t.defaultView)||window}function pt(i){var t;return(t=(sn(i)?i.ownerDocument:i.document)||window.document)==null?void 0:t.documentElement}function sn(i){return ye()?i instanceof Node||i instanceof R(i).Node:!1}function Q(i){return ye()?i instanceof Element||i instanceof R(i).Element:!1}function U(i){return ye()?i instanceof HTMLElement||i instanceof R(i).HTMLElement:!1}function ki(i){return!ye()||typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof R(i).ShadowRoot}function Ut(i){const{overflow:t,overflowX:e,overflowY:s,display:n}=B(i);return/auto|scroll|overlay|hidden|clip/.test(t+s+e)&&!["inline","contents"].includes(n)}function os(i){return["table","td","th"].includes(at(i))}function as(i){return[":popover-open",":modal"].some(t=>{try{return i.matches(t)}catch{return!1}})}function Ye(i){const t=We(),e=Q(i)?B(i):i;return["transform","translate","scale","rotate","perspective"].some(s=>e[s]?e[s]!=="none":!1)||(e.containerType?e.containerType!=="normal":!1)||!t&&(e.backdropFilter?e.backdropFilter!=="none":!1)||!t&&(e.filter?e.filter!=="none":!1)||["transform","translate","scale","rotate","perspective","filter"].some(s=>(e.willChange||"").includes(s))||["paint","layout","strict","content"].some(s=>(e.contain||"").includes(s))}function ls(i){let t=Ot(i);for(;U(t)&&!xe(t);){if(Ye(t))return t;if(as(t))return null;t=Ot(t)}return null}function We(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function xe(i){return["html","body","#document"].includes(at(i))}function B(i){return R(i).getComputedStyle(i)}function we(i){return Q(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function Ot(i){if(at(i)==="html")return i;const t=i.assignedSlot||i.parentNode||ki(i)&&i.host||pt(i);return ki(t)?t.host:t}function rn(i){const t=Ot(i);return xe(t)?i.ownerDocument?i.ownerDocument.body:i.body:U(t)&&Ut(t)?t:rn(t)}function on(i,t,e){var s;t===void 0&&(t=[]);const n=rn(i),r=n===((s=i.ownerDocument)==null?void 0:s.body),o=R(n);return r?(cs(o),t.concat(o,o.visualViewport||[],Ut(n)?n:[],[])):t.concat(n,on(n,[]))}function cs(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function an(i){const t=B(i);let e=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const n=U(i),r=n?i.offsetWidth:e,o=n?i.offsetHeight:s,a=re(e)!==r||re(s)!==o;return a&&(e=r,s=o),{width:e,height:s,$:a}}function ln(i){return Q(i)?i:i.contextElement}function St(i){const t=ln(i);if(!U(t))return ot(1);const e=t.getBoundingClientRect(),{width:s,height:n,$:r}=an(t);let o=(r?re(e.width):e.width)/s,a=(r?re(e.height):e.height)/n;return(!o||!Number.isFinite(o))&&(o=1),(!a||!Number.isFinite(a))&&(a=1),{x:o,y:a}}const us=ot(0);function cn(i){const t=R(i);return!We()||!t.visualViewport?us:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function ds(i,t,e){return t===void 0&&(t=!1),!e||t&&e!==R(i)?!1:t}function qt(i,t,e,s){t===void 0&&(t=!1),e===void 0&&(e=!1);const n=i.getBoundingClientRect(),r=ln(i);let o=ot(1);t&&(s?Q(s)&&(o=St(s)):o=St(i));const a=ds(r,e,s)?cn(r):ot(0);let l=(n.left+a.x)/o.x,c=(n.top+a.y)/o.y,u=n.width/o.x,h=n.height/o.y;if(r){const f=R(r),p=s&&Q(s)?R(s):s;let b=f,g=b.frameElement;for(;g&&s&&p!==b;){const v=St(g),k=g.getBoundingClientRect(),$=B(g),w=k.left+(g.clientLeft+parseFloat($.paddingLeft))*v.x,_=k.top+(g.clientTop+parseFloat($.paddingTop))*v.y;l*=v.x,c*=v.y,u*=v.x,h*=v.y,l+=w,c+=_,b=R(g),g=b.frameElement}}return Pt({width:u,height:h,x:l,y:c})}const hs=[":popover-open",":modal"];function un(i){return hs.some(t=>{try{return i.matches(t)}catch{return!1}})}function fs(i){let{elements:t,rect:e,offsetParent:s,strategy:n}=i;const r=n==="fixed",o=pt(s),a=t?un(t.floating):!1;if(s===o||a&&r)return e;let l={scrollLeft:0,scrollTop:0},c=ot(1);const u=ot(0),h=U(s);if((h||!h&&!r)&&((at(s)!=="body"||Ut(o))&&(l=we(s)),U(s))){const f=qt(s);c=St(s),u.x=f.x+s.clientLeft,u.y=f.y+s.clientTop}return{width:e.width*c.x,height:e.height*c.y,x:e.x*c.x-l.scrollLeft*c.x+u.x,y:e.y*c.y-l.scrollTop*c.y+u.y}}function ps(i){return Array.from(i.getClientRects())}function dn(i){return qt(pt(i)).left+we(i).scrollLeft}function ms(i){const t=pt(i),e=we(i),s=i.ownerDocument.body,n=X(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),r=X(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let o=-e.scrollLeft+dn(i);const a=-e.scrollTop;return B(s).direction==="rtl"&&(o+=X(t.clientWidth,s.clientWidth)-n),{width:n,height:r,x:o,y:a}}function bs(i,t){const e=R(i),s=pt(i),n=e.visualViewport;let r=s.clientWidth,o=s.clientHeight,a=0,l=0;if(n){r=n.width,o=n.height;const c=We();(!c||c&&t==="fixed")&&(a=n.offsetLeft,l=n.offsetTop)}return{width:r,height:o,x:a,y:l}}function gs(i,t){const e=qt(i,!0,t==="fixed"),s=e.top+i.clientTop,n=e.left+i.clientLeft,r=U(i)?St(i):ot(1),o=i.clientWidth*r.x,a=i.clientHeight*r.y,l=n*r.x,c=s*r.y;return{width:o,height:a,x:l,y:c}}function Ei(i,t,e){let s;if(t==="viewport")s=bs(i,e);else if(t==="document")s=ms(pt(i));else if(Q(t))s=gs(t,e);else{const n=cn(i);s={...t,x:t.x-n.x,y:t.y-n.y}}return Pt(s)}function hn(i,t){const e=Ot(i);return e===t||!Q(e)||xe(e)?!1:B(e).position==="fixed"||hn(e,t)}function vs(i,t){const e=t.get(i);if(e)return e;let s=on(i,[]).filter(a=>Q(a)&&at(a)!=="body"),n=null;const r=B(i).position==="fixed";let o=r?Ot(i):i;for(;Q(o)&&!xe(o);){const a=B(o),l=Ye(o);!l&&a.position==="fixed"&&(n=null),(r?!l&&!n:!l&&a.position==="static"&&!!n&&["absolute","fixed"].includes(n.position)||Ut(o)&&!l&&hn(i,o))?s=s.filter(u=>u!==o):n=a,o=Ot(o)}return t.set(i,s),s}function ys(i){let{element:t,boundary:e,rootBoundary:s,strategy:n}=i;const o=[...e==="clippingAncestors"?vs(t,this._c):[].concat(e),s],a=o[0],l=o.reduce((c,u)=>{const h=Ei(t,u,n);return c.top=X(h.top,c.top),c.right=At(h.right,c.right),c.bottom=At(h.bottom,c.bottom),c.left=X(h.left,c.left),c},Ei(t,a,n));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function xs(i){const{width:t,height:e}=an(i);return{width:t,height:e}}function ws(i,t,e){const s=U(t),n=pt(t),r=e==="fixed",o=qt(i,!0,r,t);let a={scrollLeft:0,scrollTop:0};const l=ot(0);if(s||!s&&!r)if((at(t)!=="body"||Ut(n))&&(a=we(t)),s){const h=qt(t,!0,r,t);l.x=h.x+t.clientLeft,l.y=h.y+t.clientTop}else n&&(l.x=dn(n));const c=o.left+a.scrollLeft-l.x,u=o.top+a.scrollTop-l.y;return{x:c,y:u,width:o.width,height:o.height}}function Ai(i,t){return!U(i)||B(i).position==="fixed"?null:t?t(i):i.offsetParent}function fn(i,t){const e=R(i);if(!U(i)||un(i))return e;let s=Ai(i,t);for(;s&&os(s)&&B(s).position==="static";)s=Ai(s,t);return s&&(at(s)==="html"||at(s)==="body"&&B(s).position==="static"&&!Ye(s))?e:s||ls(i)||e}const _s=async function(i){const t=this.getOffsetParent||fn,e=this.getDimensions;return{reference:ws(i.reference,await t(i.floating),i.strategy),floating:{x:0,y:0,...await e(i.floating)}}};function Cs(i){return B(i).direction==="rtl"}const $s={convertOffsetParentRelativeRectToViewportRelativeRect:fs,getDocumentElement:pt,getClippingRect:ys,getOffsetParent:fn,getElementRects:_s,getClientRects:ps,getDimensions:xs,getScale:St,isElement:Q,isRTL:Cs},pn=rs,mn=es,bn=ns,gn=(i,t,e)=>{const s=new Map,n={platform:$s,...e},r={...n.platform,_c:s};return ts(i,t,{...n,platform:r})};/**
* (c) Iconify
*
...
* @license MIT
* @version 2.0.0
*/const vn=Object.freeze({left:0,top:0,width:16,height:16}),ae=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),Gt=Object.freeze({...vn,...ae}),Le=Object.freeze({...Gt,body:"",hidden:!1}),Ss=Object.freeze({width:null,height:null}),yn=Object.freeze({...Ss,...ae});function ks(i,t=0){const e=i.replace(/^-?[0-9.]*/,"");function s(n){for(;n<0;)n+=4;return n%4}if(e===""){const n=parseInt(i);return isNaN(n)?0:s(n)}else if(e!==i){let n=0;switch(e){case"%":n=25;break;case"deg":n=90}if(n){let r=parseFloat(i.slice(0,i.length-e.length));return isNaN(r)?0:(r=r/n,r%1===0?s(r):0)}}return t}const Es=/[\s,]+/;function As(i,t){t.split(Es).forEach(e=>{switch(e.trim()){case"horizontal":i.hFlip=!0;break;case"vertical":i.vFlip=!0;break}})}const xn={...yn,preserveAspectRatio:""};function Pi(i){const t={...xn},e=(s,n)=>i.getAttribute(s)||n;return t.width=e("width",null),t.height=e("height",null),t.rotate=ks(e("rotate","")),As(t,e("flip","")),t.preserveAspectRatio=e("preserveAspectRatio",e("preserveaspectratio","")),t}function Ps(i,t){for(const e in xn)if(i[e]!==t[e])return!0;return!1}const Mt=/^[a-z0-9]+(-[a-z0-9]+)*$/,Xt=(i,t,e,s="")=>{const n=i.split(":");if(i.slice(0,1)==="@"){if(n.length<2||n.length>3)return null;s=n.shift().slice(1)}if(n.length>3||!n.length)return null;if(n.length>1){const a=n.pop(),l=n.pop(),c={provider:n.length>0?n[0]:s,prefix:l,name:a};return t&&!ne(c)?null:c}const r=n[0],o=r.split("-");if(o.length>1){const a={provider:s,prefix:o.shift(),name:o.join("-")};return t&&!ne(a)?null:a}if(e&&s===""){const a={provider:s,prefix:"",name:r};return t&&!ne(a,e)?null:a}return null},ne=(i,t)=>i?!!((i.provider===""||i.provider.match(Mt))&&(t&&i.prefix===""||i.prefix.match(Mt))&&i.name.match(Mt)):!1;function Os(i,t){const e={};!i.hFlip!=!t.hFlip&&(e.hFlip=!0),!i.vFlip!=!t.vFlip&&(e.vFlip=!0);const s=((i.rotate||0)+(t.rotate||0))%4;return s&&(e.rotate=s),e}function Oi(i,t){const e=Os(i,t);for(const s in Le)s in ae?s in i&&!(s in e)&&(e[s]=ae[s]):s in t?e[s]=t[s]:s in i&&(e[s]=i[s]);return e}function Ts(i,t){const e=i.icons,s=i.aliases||Object.create(null),n=Object.create(null);function r(o){if(e[o])return n[o]=[];if(!(o in n)){n[o]=null;const a=s[o]&&s[o].parent,l=a&&r(a);l&&(n[o]=[a].concat(l))}return n[o]}return Object.keys(e).concat(Object.keys(s)).forEach(r),n}function Is(i,t,e){const s=i.icons,n=i.aliases||Object.create(null);let r={};function o(a){r=Oi(s[a]||n[a],r)}return o(t),e.forEach(o),Oi(i,r)}function wn(i,t){const e=[];if(typeof i!="object"||typeof i.icons!="object")return e;i.not_found instanceof Array&&i.not_found.forEach(n=>{t(n,null),e.push(n)});const s=Ts(i);for(const n in s){const r=s[n];r&&(t(n,Is(i,n,r)),e.push(n))}return e}const Ls={provider:"",aliases:{},not_found:{},...vn};function Ae(i,t){for(const e in t)if(e in i&&typeof i[e]!=typeof t[e])return!1;return!0}function _n(i){if(typeof i!="object"||i===null)return null;const t=i;if(typeof t.prefix!="string"||!i.icons||typeof i.icons!="object"||!Ae(i,Ls))return null;const e=t.icons;for(const n in e){const r=e[n];if(!n.match(Mt)||typeof r.body!="string"||!Ae(r,Le))return null}const s=t.aliases||Object.create(null);for(const n in s){const r=s[n],o=r.parent;if(!n.match(Mt)||typeof o!="string"||!e[o]&&!s[o]||!Ae(r,Le))return null}return t}const le=Object.create(null);function zs(i,t){return{provider:i,prefix:t,icons:Object.create(null),missing:new Set}}function lt(i,t){const e=le[i]||(le[i]=Object.create(null));return e[t]||(e[t]=zs(i,t))}function Qe(i,t){return _n(t)?wn(t,(e,s)=>{s?i.icons[e]=s:i.missing.add(e)}):[]}function Rs(i,t,e){try{if(typeof e.body=="string")return i.icons[t]={...e},!0}catch{}return!1}function Bs(i,t){let e=[];return(typeof i=="string"?[i]:Object.keys(le)).forEach(n=>{(typeof n=="string"&&typeof t=="string"?[t]:Object.keys(le[n]||{})).forEach(o=>{const a=lt(n,o);e=e.concat(Object.keys(a.icons).map(l=>(n!==""?"@"+n+":":"")+o+":"+l))})}),e}let Nt=!1;function Cn(i){return typeof i=="boolean"&&(Nt=i),Nt}function Vt(i){const t=typeof i=="string"?Xt(i,!0,Nt):i;if(t){const e=lt(t.provider,t.prefix),s=t.name;return e.icons[s]||(e.missing.has(s)?null:void 0)}}function $n(i,t){const e=Xt(i,!0,Nt);if(!e)return!1;const s=lt(e.provider,e.prefix);return Rs(s,e.name,t)}function Ti(i,t){if(typeof i!="object")return!1;if(typeof t!="string"&&(t=i.provider||""),Nt&&!t&&!i.prefix){let n=!1;return _n(i)&&(i.prefix="",wn(i,(r,o)=>{o&&$n(r,o)&&(n=!0)})),n}const e=i.prefix;if(!ne({provider:t,prefix:e,name:"a"}))return!1;const s=lt(t,e);return!!Qe(s,i)}function Ii(i){return!!Vt(i)}function js(i){const t=Vt(i);return t?{...Gt,...t}:null}function Fs(i){const t={loaded:[],missing:[],pending:[]},e=Object.create(null);i.sort((n,r)=>n.provider!==r.provider?n.provider.localeCompare(r.provider):n.prefix!==r.prefix?n.prefix.localeCompare(r.prefix):n.name.localeCompare(r.name));let s={provider:"",prefix:"",name:""};return i.forEach(n=>{if(s.name===n.name&&s.prefix===n.prefix&&s.provider===n.provider)return;s=n;const r=n.provider,o=n.prefix,a=n.name,l=e[r]||(e[r]=Object.create(null)),c=l[o]||(l[o]=lt(r,o));let u;a in c.icons?u=t.loaded:o===""||c.missing.has(a)?u=t.missing:u=t.pending;const h={provider:r,prefix:o,name:a};u.push(h)}),t}function Sn(i,t){i.forEach(e=>{const s=e.loaderCallbacks;s&&(e.loaderCallbacks=s.filter(n=>n.id!==t))})}function Ms(i){i.pendingCallbacksFlag||(i.pendingCallbacksFlag=!0,setTimeout(()=>{i.pendingCallbacksFlag=!1;const t=i.loaderCallbacks?i.loaderCallbacks.slice(0):[];if(!t.length)return;let e=!1;const s=i.provider,n=i.prefix;t.forEach(r=>{const o=r.icons,a=o.pending.length;o.pending=o.pending.filter(l=>{if(l.prefix!==n)return!0;const c=l.name;if(i.icons[c])o.loaded.push({provider:s,prefix:n,name:c});else if(i.missing.has(c))o.missing.push({provider:s,prefix:n,name:c});else return e=!0,!0;return!1}),o.pending.length!==a&&(e||Sn([i],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let Ds=0;function Hs(i,t,e){const s=Ds++,n=Sn.bind(null,e,s);if(!t.pending.length)return n;const r={id:s,icons:t,callback:i,abort:n};return e.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),n}const ze=Object.create(null);function Li(i,t){ze[i]=t}function Re(i){return ze[i]||ze[""]}function qs(i,t=!0,e=!1){const s=[];return i.forEach(n=>{const r=typeof n=="string"?Xt(n,t,e):n;r&&s.push(r)}),s}var Ns={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Vs(i,t,e,s){const n=i.resources.length,r=i.random?Math.floor(Math.random()*n):i.index;let o;if(i.random){let x=i.resources.slice(0);for(o=[];x.length>1;){const T=Math.floor(Math.random()*x.length);o.push(x[T]),x=x.slice(0,T).concat(x.slice(T+1))}o=o.concat(x)}else o=i.resources.slice(r).concat(i.resources.slice(0,r));const a=Date.now();let l="pending",c=0,u,h=null,f=[],p=[];typeof s=="function"&&p.push(s);function b(){h&&(clearTimeout(h),h=null)}function g(){l==="pending"&&(l="aborted"),b(),f.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),f=[]}function v(x,T){T&&(p=[]),typeof x=="function"&&p.push(x)}function k(){return{startTime:a,payload:t,status:l,queriesSent:c,queriesPending:f.length,subscribe:v,abort:g}}function $(){l="failed",p.forEach(x=>{x(void 0,u)})}function w(){f.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),f=[]}function _(x,T,D){const H=T!=="success";switch(f=f.filter(E=>E!==x),l){case"pending":break;case"failed":if(H||!i.dataAfterTimeout)return;break;default:return}if(T==="abort"){u=D,$();return}if(H){u=D,f.length||(o.length?A():$());return}if(b(),w(),!i.random){const E=i.resources.indexOf(x.resource);E!==-1&&E!==i.index&&(i.index=E)}l="completed",p.forEach(E=>{E(D)})}function A(){if(l!=="pending")return;b();const x=o.shift();if(x===void 0){if(f.length){h=setTimeout(()=>{b(),l==="pending"&&(w(),$())},i.timeout);return}$();return}const T={status:"pending",resource:x,callback:(D,H)=>{_(T,D,H)}};f.push(T),c++,h=setTimeout(A,i.rotate),e(x,t,T.callback)}return setTimeout(A),k}function kn(i){const t={...Ns,...i};let e=[];function s(){e=e.filter(a=>a().status==="pending")}function n(a,l,c){const u=Vs(t,a,l,(h,f)=>{s(),c&&c(h,f)});return e.push(u),u}function r(a){return e.find(l=>a(l))||null}return{query:n,find:r,setIndex:a=>{t.index=a},getIndex:()=>t.index,cleanup:s}}function Ue(i){let t;if(typeof i.resources=="string")t=[i.resources];else if(t=i.resources,!(t instanceof Array)||!t.length)return null;return{resources:t,path:i.path||"/",maxURL:i.maxURL||500,rotate:i.rotate||750,timeout:i.timeout||5e3,random:i.random===!0,index:i.index||0,dataAfterTimeout:i.dataAfterTimeout!==!1}}const _e=Object.create(null),Ft=["https://api.simplesvg.com","https://api.unisvg.com"],se=[];for(;Ft.length>0;)Ft.length===1||Math.random()>.5?se.push(Ft.shift()):se.push(Ft.pop());_e[""]=Ue({resources:["https://api.iconify.design"].concat(se)});function zi(i,t){const e=Ue(t);return e===null?!1:(_e[i]=e,!0)}function Ce(i){return _e[i]}function Ys(){return Object.keys(_e)}function Ri(){}const Pe=Object.create(null);function Ws(i){if(!Pe[i]){const t=Ce(i);if(!t)return;const e=kn(t),s={config:t,redundancy:e};Pe[i]=s}return Pe[i]}function En(i,t,e){let s,n;if(typeof i=="string"){const r=Re(i);if(!r)return e(void 0,424),Ri;n=r.send;const o=Ws(i);o&&(s=o.redundancy)}else{const r=Ue(i);if(r){s=kn(r);const o=i.resources?i.resources[0]:"",a=Re(o);a&&(n=a.send)}}return!s||!n?(e(void 0,424),Ri):s.query(t,n,e)().abort}const Bi="iconify2",Yt="iconify",An=Yt+"-count",ji=Yt+"-version",Pn=36e5,Qs=168,Us=50;function Be(i,t){try{return i.getItem(t)}catch{}}function Ge(i,t,e){try{return i.setItem(t,e),!0}catch{}}function Fi(i,t){try{i.removeItem(t)}catch{}}function je(i,t){return Ge(i,An,t.toString())}function Fe(i){return parseInt(Be(i,An))||0}const vt={local:!0,session:!0},On={local:new Set,session:new Set};let Xe=!1;function Gs(i){Xe=i}let ie=typeof window>"u"?{}:window;function Tn(i){const t=i+"Storage";try{if(ie&&ie[t]&&typeof ie[t].length=="number")return ie[t]}catch{}vt[i]=!1}function In(i,t){const e=Tn(i);if(!e)return;const s=Be(e,ji);if(s!==Bi){if(s){const a=Fe(e);for(let l=0;l<a;l++)Fi(e,Yt+l.toString())}Ge(e,ji,Bi),je(e,0);return}const n=Math.floor(Date.now()/Pn)-Qs,r=a=>{const l=Yt+a.toString(),c=Be(e,l);if(typeof c=="string"){try{const u=JSON.parse(c);if(typeof u=="object"&&typeof u.cached=="number"&&u.cached>n&&typeof u.provider=="string"&&typeof u.data=="object"&&typeof u.data.prefix=="string"&&t(u,a))return!0}catch{}Fi(e,l)}};let o=Fe(e);for(let a=o-1;a>=0;a--)r(a)||(a===o-1?(o--,je(e,o)):On[i].add(a))}function Ln(){if(!Xe){Gs(!0);for(const i in vt)In(i,t=>{const e=t.data,s=t.provider,n=e.prefix,r=lt(s,n);if(!Qe(r,e).length)return!1;const o=e.lastModified||-1;return r.lastModifiedCached=r.lastModifiedCached?Math.min(r.lastModifiedCached,o):o,!0})}}function Xs(i,t){const e=i.lastModifiedCached;if(e&&e>=t)return e===t;if(i.lastModifiedCached=t,e)for(const s in vt)In(s,n=>{const r=n.data;return n.provider!==i.provider||r.prefix!==i.prefix||r.lastModified===t});return!0}function Ks(i,t){Xe||Ln();function e(s){let n;if(!vt[s]||!(n=Tn(s)))return;const r=On[s];let o;if(r.size)r.delete(o=Array.from(r).shift());else if(o=Fe(n),o>=Us||!je(n,o+1))return;const a={cached:Math.floor(Date.now()/Pn),provider:i.provider,data:t};return Ge(n,Yt+o.toString(),JSON.stringify(a))}t.lastModified&&!Xs(i,t.lastModified)||Object.keys(t.icons).length&&(t.not_found&&(t=Object.assign({},t),delete t.not_found),e("local")||e("session"))}function Mi(){}function Js(i){i.iconsLoaderFlag||(i.iconsLoaderFlag=!0,setTimeout(()=>{i.iconsLoaderFlag=!1,Ms(i)}))}function Zs(i,t){i.iconsToLoad?i.iconsToLoad=i.iconsToLoad.concat(t).sort():i.iconsToLoad=t,i.iconsQueueFlag||(i.iconsQueueFlag=!0,setTimeout(()=>{i.iconsQueueFlag=!1;const{provider:e,prefix:s}=i,n=i.iconsToLoad;delete i.iconsToLoad;let r;if(!n||!(r=Re(e)))return;r.prepare(e,s,n).forEach(a=>{En(e,a,l=>{if(typeof l!="object")a.icons.forEach(c=>{i.missing.add(c)});else try{const c=Qe(i,l);if(!c.length)return;const u=i.pendingIcons;u&&c.forEach(h=>{u.delete(h)}),Ks(i,l)}catch(c){console.error(c)}Js(i)})})}))}const Ke=(i,t)=>{const e=qs(i,!0,Cn()),s=Fs(e);if(!s.pending.length){let l=!0;return t&&setTimeout(()=>{l&&t(s.loaded,s.missing,s.pending,Mi)}),()=>{l=!1}}const n=Object.create(null),r=[];let o,a;return s.pending.forEach(l=>{const{provider:c,prefix:u}=l;if(u===a&&c===o)return;o=c,a=u,r.push(lt(c,u));const h=n[c]||(n[c]=Object.create(null));h[u]||(h[u]=[])}),s.pending.forEach(l=>{const{provider:c,prefix:u,name:h}=l,f=lt(c,u),p=f.pendingIcons||(f.pendingIcons=new Set);p.has(h)||(p.add(h),n[c][u].push(h))}),r.forEach(l=>{const{provider:c,prefix:u}=l;n[c][u].length&&Zs(l,n[c][u])}),t?Hs(t,s,r):Mi},tr=i=>new Promise((t,e)=>{const s=typeof i=="string"?Xt(i,!0):i;if(!s){e(i);return}Ke([s||i],n=>{if(n.length&&s){const r=Vt(s);if(r){t({...Gt,...r});return}}e(i)})});function er(i){try{const t=typeof i=="string"?JSON.parse(i):i;if(typeof t.body=="string")return{...t}}catch{}}function ir(i,t){const e=typeof i=="string"?Xt(i,!0,!0):null;if(!e){const r=er(i);return{value:i,data:r}}const s=Vt(e);if(s!==void 0||!e.prefix)return{value:i,name:e,data:s};const n=Ke([e],()=>t(i,e,Vt(e)));return{value:i,name:e,loading:n}}function Oe(i){return i.hasAttribute("inline")}let zn=!1;try{zn=navigator.vendor.indexOf("Apple")===0}catch{}function nr(i,t){switch(t){case"svg":case"bg":case"mask":return t}return t!=="style"&&(zn||i.indexOf("<a")===-1)?"svg":i.indexOf("currentColor")===-1?"bg":"mask"}const sr=/(-?[0-9.]*[0-9]+[0-9.]*)/g,rr=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Me(i,t,e){if(t===1)return i;if(e=e||100,typeof i=="number")return Math.ceil(i*t*e)/e;if(typeof i!="string")return i;const s=i.split(sr);if(s===null||!s.length)return i;const n=[];let r=s.shift(),o=rr.test(r);for(;;){if(o){const a=parseFloat(r);isNaN(a)?n.push(r):n.push(Math.ceil(a*t*e)/e)}else n.push(r);if(r=s.shift(),r===void 0)return n.join("");o=!o}}function or(i,t="defs"){let e="";const s=i.indexOf("<"+t);for(;s>=0;){const n=i.indexOf(">",s),r=i.indexOf("</"+t);if(n===-1||r===-1)break;const o=i.indexOf(">",r);if(o===-1)break;e+=i.slice(n+1,r).trim(),i=i.slice(0,s).trim()+i.slice(o+1)}return{defs:e,content:i}}function ar(i,t){return i?"<defs>"+i+"</defs>"+t:t}function lr(i,t,e){const s=or(i);return ar(s.defs,t+s.content+e)}const cr=i=>i==="unset"||i==="undefined"||i==="none";function Rn(i,t){const e={...Gt,...i},s={...yn,...t},n={left:e.left,top:e.top,width:e.width,height:e.height};let r=e.body;[e,s].forEach(g=>{const v=[],k=g.hFlip,$=g.vFlip;let w=g.rotate;k?$?w+=2:(v.push("translate("+(n.width+n.left).toString()+" "+(0-n.top).toString()+")"),v.push("scale(-1 1)"),n.top=n.left=0):$&&(v.push("translate("+(0-n.left).toString()+" "+(n.height+n.top).toString()+")"),v.push("scale(1 -1)"),n.top=n.left=0);let _;switch(w<0&&(w-=Math.floor(w/4)*4),w=w%4,w){case 1:_=n.height/2+n.top,v.unshift("rotate(90 "+_.toString()+" "+_.toString()+")");break;case 2:v.unshift("rotate(180 "+(n.width/2+n.left).toString()+" "+(n.height/2+n.top).toString()+")");break;case 3:_=n.width/2+n.left,v.unshift("rotate(-90 "+_.toString()+" "+_.toString()+")");break}w%2===1&&(n.left!==n.top&&(_=n.left,n.left=n.top,n.top=_),n.width!==n.height&&(_=n.width,n.width=n.height,n.height=_)),v.length&&(r=lr(r,'<g transform="'+v.join(" ")+'">',"</g>"))});const o=s.width,a=s.height,l=n.width,c=n.height;let u,h;o===null?(h=a===null?"1em":a==="auto"?c:a,u=Me(h,l/c)):(u=o==="auto"?l:o,h=a===null?Me(u,c/l):a==="auto"?c:a);const f={},p=(g,v)=>{cr(v)||(f[g]=v.toString())};p("width",u),p("height",h);const b=[n.left,n.top,l,c];return f.viewBox=b.join(" "),{attributes:f,viewBox:b,body:r}}function Je(i,t){let e=i.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in t)e+=" "+s+'="'+t[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+e+">"+i+"</svg>"}function ur(i){return i.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function dr(i){return"data:image/svg+xml,"+ur(i)}function Bn(i){return'url("'+dr(i)+'")'}const hr=()=>{let i;try{if(i=fetch,typeof i=="function")return i}catch{}};let ce=hr();function fr(i){ce=i}function pr(){return ce}function mr(i,t){const e=Ce(i);if(!e)return 0;let s;if(!e.maxURL)s=0;else{let n=0;e.resources.forEach(o=>{n=Math.max(n,o.length)});const r=t+".json?icons=";s=e.maxURL-n-e.path.length-r.length}return s}function br(i){return i===404}const gr=(i,t,e)=>{const s=[],n=mr(i,t),r="icons";let o={type:r,provider:i,prefix:t,icons:[]},a=0;return e.forEach((l,c)=>{a+=l.length+1,a>=n&&c>0&&(s.push(o),o={type:r,provider:i,prefix:t,icons:[]},a=l.length),o.icons.push(l)}),s.push(o),s};function vr(i){if(typeof i=="string"){const t=Ce(i);if(t)return t.path}return"/"}const yr=(i,t,e)=>{if(!ce){e("abort",424);return}let s=vr(t.provider);switch(t.type){case"icons":{const r=t.prefix,a=t.icons.join(","),l=new URLSearchParams({icons:a});s+=r+".json?"+l.toString();break}case"custom":{const r=t.uri;s+=r.slice(0,1)==="/"?r.slice(1):r;break}default:e("abort",400);return}let n=503;ce(i+s).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{e(br(o)?"abort":"next",o)});return}return n=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?e("abort",r):e("next",n)});return}setTimeout(()=>{e("success",r)})}).catch(()=>{e("next",n)})},xr={prepare:gr,send:yr};function Di(i,t){switch(i){case"local":case"session":vt[i]=t;break;case"all":for(const e in vt)vt[e]=t;break}}const Te="data-style";let jn="";function wr(i){jn=i}function Hi(i,t){let e=Array.from(i.childNodes).find(s=>s.hasAttribute&&s.hasAttribute(Te));e||(e=document.createElement("style"),e.setAttribute(Te,Te),i.appendChild(e)),e.textContent=":host{display:inline-block;vertical-align:"+(t?"-0.125em":"0")+"}span,svg{display:block}"+jn}function Fn(){Li("",xr),Cn(!0);let i;try{i=window}catch{}if(i){if(Ln(),i.IconifyPreload!==void 0){const e=i.IconifyPreload,s="Invalid IconifyPreload syntax.";typeof e=="object"&&e!==null&&(e instanceof Array?e:[e]).forEach(n=>{try{(typeof n!="object"||n===null||n instanceof Array||typeof n.icons!="object"||typeof n.prefix!="string"||!Ti(n))&&console.error(s)}catch{console.error(s)}})}if(i.IconifyProviders!==void 0){const e=i.IconifyProviders;if(typeof e=="object"&&e!==null)for(const s in e){const n="IconifyProviders["+s+"] is invalid.";try{const r=e[s];if(typeof r!="object"||!r||r.resources===void 0)continue;zi(s,r)||console.error(n)}catch{console.error(n)}}}}return{enableCache:e=>Di(e,!0),disableCache:e=>Di(e,!1),iconLoaded:Ii,iconExists:Ii,getIcon:js,listIcons:Bs,addIcon:$n,addCollection:Ti,calculateSize:Me,buildIcon:Rn,iconToHTML:Je,svgToURL:Bn,loadIcons:Ke,loadIcon:tr,addAPIProvider:zi,appendCustomStyle:wr,_api:{getAPIConfig:Ce,setAPIModule:Li,sendAPIQuery:En,setFetch:fr,getFetch:pr,listAPIProviders:Ys}}}const De={"background-color":"currentColor"},Mn={"background-color":"transparent"},qi={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},Ni={"-webkit-mask":De,mask:De,background:Mn};for(const i in Ni){const t=Ni[i];for(const e in qi)t[i+"-"+e]=qi[e]}function Vi(i){return i?i+(i.match(/^[-0-9.]+$/)?"px":""):"inherit"}function _r(i,t,e){const s=document.createElement("span");let n=i.body;n.indexOf("<a")!==-1&&(n+="<!-- "+Date.now()+" -->");const r=i.attributes,o=Je(n,{...r,width:t.width+"",height:t.height+""}),a=Bn(o),l=s.style,c={"--svg":a,width:Vi(r.width),height:Vi(r.height),...e?De:Mn};for(const u in c)l.setProperty(u,c[u]);return s}let Dt;function Cr(){try{Dt=window.trustedTypes.createPolicy("iconify",{createHTML:i=>i})}catch{Dt=null}}function $r(i){return Dt===void 0&&Cr(),Dt?Dt.createHTML(i):i}function Sr(i){const t=document.createElement("span"),e=i.attributes;let s="";e.width||(s="width: inherit;"),e.height||(s+="height: inherit;"),s&&(e.style=s);const n=Je(i.body,e);return t.innerHTML=$r(n),t.firstChild}function He(i){return Array.from(i.childNodes).find(t=>{const e=t.tagName&&t.tagName.toUpperCase();return e==="SPAN"||e==="SVG"})}function Yi(i,t){const e=t.icon.data,s=t.customisations,n=Rn(e,s);s.preserveAspectRatio&&(n.attributes.preserveAspectRatio=s.preserveAspectRatio);const r=t.renderedMode;let o;switch(r){case"svg":o=Sr(n);break;default:o=_r(n,{...Gt,...e},r==="mask")}const a=He(i);a?o.tagName==="SPAN"&&a.tagName===o.tagName?a.setAttribute("style",o.getAttribute("style")):i.replaceChild(o,a):i.appendChild(o)}function Wi(i,t,e){const s=e&&(e.rendered?e:e.lastRender);return{rendered:!1,inline:t,icon:i,lastRender:s}}function kr(i="iconify-icon"){let t,e;try{t=window.customElements,e=window.HTMLElement}catch{return}if(!t||!e)return;const s=t.get(i);if(s)return s;const n=["icon","mode","inline","observe","width","height","rotate","flip"],r=class extends e{constructor(){super();rt(this,"_shadowRoot");rt(this,"_initialised",!1);rt(this,"_state");rt(this,"_checkQueued",!1);rt(this,"_connected",!1);rt(this,"_observer",null);rt(this,"_visible",!0);const l=this._shadowRoot=this.attachShadow({mode:"open"}),c=Oe(this);Hi(l,c),this._state=Wi({value:""},c),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return n.slice(0)}attributeChangedCallback(l){switch(l){case"inline":{const c=Oe(this),u=this._state;c!==u.inline&&(u.inline=c,Hi(this._shadowRoot,c));break}case"observer":{this.observer?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const l=this.getAttribute("icon");if(l&&l.slice(0,1)==="{")try{return JSON.parse(l)}catch{}return l}set icon(l){typeof l=="object"&&(l=JSON.stringify(l)),this.setAttribute("icon",l)}get inline(){return Oe(this)}set inline(l){l?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(l){l?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const l=this._state;if(l.rendered){const c=this._shadowRoot;if(l.renderedMode==="svg")try{c.lastChild.setCurrentTime(0);return}catch{}Yi(c,l)}}get status(){const l=this._state;return l.rendered?"rendered":l.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const l=this._state,c=this.getAttribute("icon");if(c!==l.icon.value){this._iconChanged(c);return}if(!l.rendered||!this._visible)return;const u=this.getAttribute("mode"),h=Pi(this);(l.attrMode!==u||Ps(l.customisations,h)||!He(this._shadowRoot))&&this._renderIcon(l.icon,h,u)}_iconChanged(l){const c=ir(l,(u,h,f)=>{const p=this._state;if(p.rendered||this.getAttribute("icon")!==u)return;const b={value:u,name:h,data:f};b.data?this._gotIconData(b):p.icon=b});c.data?this._gotIconData(c):this._state=Wi(c,this._state.inline,this._state)}_forceRender(){if(!this._visible){const l=He(this._shadowRoot);l&&this._shadowRoot.removeChild(l);return}this._queueCheck()}_gotIconData(l){this._checkQueued=!1,this._renderIcon(l,Pi(this),this.getAttribute("mode"))}_renderIcon(l,c,u){const h=nr(l.data.body,u),f=this._state.inline;Yi(this._shadowRoot,this._state={rendered:!0,icon:l,inline:f,customisations:c,attrMode:u,renderedMode:h})}startObserver(){if(!this._observer)try{this._observer=new IntersectionObserver(l=>{const c=l.some(u=>u.isIntersecting);c!==this._visible&&(this._visible=c,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};n.forEach(a=>{a in r.prototype||Object.defineProperty(r.prototype,a,{get:function(){return this.getAttribute(a)},set:function(l){l!==null?this.setAttribute(a,l):this.removeAttribute(a)}})});const o=Fn();for(const a in o)r[a]=r.prototype[a]=o[a];return t.define(i,r),r}const Er=kr()||Fn(),{enableCache:Eo,disableCache:Ao,iconLoaded:Po,iconExists:Oo,getIcon:To,listIcons:Io,addIcon:Lo,addCollection:zo,calculateSize:Ro,buildIcon:Bo,iconToHTML:jo,svgToURL:Fo,loadIcons:Mo,loadIcon:Do,addAPIProvider:Ho,_api:qo}=Er,Ar=C`
  ::-webkit-scrollbar {
    width: 0.4rem;
    height: 0.4rem;
    overflow: hidden;
...
`,mt={scrollbar:Ar,globalStyles:Pr},y=class y{static set config(t){this._config={...y._config,...t}}static get config(){return y._config}static addGlobalStyles(){let t=document.querySelector("style[id='bim-ui']");if(t)return;t=document.createElement("style"),t.id="bim-ui",t.textContent=mt.globalStyles.cssText;const e=document.head.firstChild;e?document.head.insertBefore(t,e):document.head.append(t)}static defineCustomElement(t,e){customElements.get(t)||customElements.define(t,e)}static registerComponents(){y.init()}static init(t="",e=!0){y.addGlobalStyles(),y.defineCustomElement("bim-button",Rr),y.defineCustomElement("bim-checkbox",ct),y.defineCustomElement("bim-color-input",J),y.defineCustomElement("bim-context-menu",Ne),y.defineCustomElement("bim-dropdown",q),y.defineCustomElement("bim-grid",Wt),y.defineCustomElement("bim-icon",Ve),y.defineCustomElement("bim-input",wt),y.defineCustomElement("bim-label",ut),y.defineCustomElement("bim-number-input",L),y.defineCustomElement("bim-option",O),y.defineCustomElement("bim-panel",Z),y.defineCustomElement("bim-panel-section",dt),y.defineCustomElement("bim-selector",ht),y.defineCustomElement("bim-table",z),y.defineCustomElement("bim-tabs",G),y.defineCustomElement("bim-tab",I),y.defineCustomElement("bim-table-cell",fe),y.defineCustomElement("bim-table-children",pe),y.defineCustomElement("bim-table-group",me),y.defineCustomElement("bim-table-row",tt),y.defineCustomElement("bim-text-input",j),y.defineCustomElement("bim-toolbar",It),y.defineCustomElement("bim-toolbar-group",Tt),y.defineCustomElement("bim-toolbar-section",ft),y.defineCustomElement("bim-viewport",be),e&&this.animateOnLoad(t)}static newRandomId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";let e="";for(let s=0;s<10;s++){const n=Math.floor(Math.random()*t.length);e+=t.charAt(n)}return e}static animateOnLoad(t=""){const e=`
  ...
  `;let O=ni;bt([d({type:String,reflect:!0})],O.prototype,"img",2);bt([d({type:String,reflect:!0})],O.prototype,"label",2);bt([d({type:String,reflect:!0})],O.prototype,"icon",2);bt([d({type:Boolean,reflect:!0})],O.prototype,"checked",2);bt([d({type:Boolean,reflect:!0})],O.prototype,"checkbox",2);bt([d({type:Boolean,attribute:"no-mark",reflect:!0})],O.prototype,"noMark",2);bt([d({converter:{fromAttribute(i){return i&&$e(i)}}})],O.prototype,"value",1);bt([d({type:Boolean,reflect:!0})],O.prototype,"vertical",2);var Dr=Object.defineProperty,Hr=Object.getOwnPropertyDescriptor,gt=(i,t,e,s)=>{for(var n=s>1?void 0:s?Hr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Dr(t,e,n),n};const si=class si extends de{constructor(){super(),this.multiple=!1,this.required=!1,this.vertical=!1,this._visible=!1,this._value=new Set,this.onValueChange=new Event("change"),this._contextMenu=kt(),this.onOptionClick=t=>{const e=t.target,s=this._value.has(e);if(!this.multiple&&!this.required&&!s)this._value=new Set([e]);else if(!this.multiple&&!this.required&&s)this._value=new Set([]);else if(!this.multiple&&this.required&&!s)this._value=new Set([e]);else if(this.multiple&&!this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&!this.required&&s){const n=[...this._value].filter(r=>r!==e);this._value=new Set(n)}else if(this.multiple&&this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&this.required&&s){const n=[...this._value].filter(o=>o!==e),r=new Set(n);r.size!==0&&(this._value=r)}this.updateOptionsState(),this.dispatchEvent(this.onValueChange)},this.useObserver=!0}set visible(t){if(t){const{value:e}=this._contextMenu;if(!e)return;for(const s of this.elements)e.append(s);this._visible=!0}else{for(const e of this.elements)this.append(e);this._visible=!1,this.resetVisibleElements()}}get visible(){return this._visible}set value(t){if(this.required&&Object.keys(t).length===0)return;const e=new Set;for(const s of t){const n=this.findOption(s);if(n&&(e.add(n),!this.multiple&&Object.keys(t).length===1))break}this._value=e,this.updateOptionsState(),this.dispatchEvent(this.onValueChange)}get value(){return[...this._value].filter(e=>e instanceof O&&e.checked).map(e=>e.value)}get _options(){const t=new Set([...this.elements]);for(const e of this.children)e instanceof O&&t.add(e);return[...t]}onSlotChange(t){const e=t.target.assignedElements();this.observe(e);const s=new Set;for(const n of this.elements){if(!(n instanceof O)){n.remove();continue}n.checked&&s.add(n),n.removeEventListener("click",this.onOptionClick),n.addEventListener("click",this.onOptionClick)}this._value=s}updateOptionsState(){for(const t of this._options)t instanceof O&&(t.checked=this._value.has(t))}findOption(t){return this._options.find(s=>s instanceof O?s.label===t||s.value===t:!1)}render(){let t,e,s;if(this._value.size===0)t="Select an option...";else if(this._value.size===1){const n=[...this._value][0];t=(n==null?void 0:n.label)||(n==null?void 0:n.value),e=n==null?void 0:n.img,s=n==null?void 0:n.icon}else t=`Multiple (${this._value.size})`;return m`
    ...
    `];let q=si;gt([d({type:String,reflect:!0})],q.prototype,"name",2);gt([d({type:String,reflect:!0})],q.prototype,"icon",2);gt([d({type:String,reflect:!0})],q.prototype,"label",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"multiple",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"required",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"vertical",2);gt([d({type:Boolean,reflect:!0})],q.prototype,"visible",1);gt([Lt()],q.prototype,"_value",2);var qr=Object.defineProperty,Hn=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&qr(t,e,n),n};const ri=class ri extends S{constructor(){super(...arguments),this.floating=!1,this._layouts={},this._updateFunctions={}}set layouts(t){this._layouts=t;const e={};for(const[s,n]of Object.entries(t))for(const r in n.elements)e[s]||(e[s]={}),e[s][r]=o=>{const a=this._updateFunctions[s];if(!a)return;const l=a[r];l&&l(o)};this.updateComponent=e}get layouts(){return this._layouts}getLayoutAreas(t){const{template:e}=t,r=e.split(`
`).map(a=>a.trim()).map(a=>a.split('"')[1]).filter(a=>a!==void 0).flatMap(a=>a.split(/\s+/));return[...new Set(r)].filter(a=>a!=="")}firstUpdated(){this._onLayoutChange=new Event("layoutchange")}render(){if(this.layout){if(this._updateFunctions={},this.layouts[this.layout]){this.innerHTML="",this._updateFunctions[this.layout]={};const t=this._updateFunctions[this.layout],e=this.layouts[this.layout],n=this.getLayoutAreas(e).map(r=>{const o=e.elements[r];if(!o)return null;if(o instanceof HTMLElement)return o.style.gridArea=r,o;if("template"in o){const{template:l,initialState:c}=o,[u,h]=de.create(l,c);return u.style.gridArea=r,t[r]=h,u}return de.create(o)}).filter(r=>!!r);this.style.gridTemplate=e.template,this.append(...n),this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange)}}else this._updateFunctions={},this.innerHTML="",this.style.gridTemplate="",this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange);return m`<slot></slot>`}};ri.styles=C`
    :host {
      display: grid;
      height: 100%;
      width: 100%;
  ...
  `;let Wt=ri;Hn([d({type:Boolean,reflect:!0})],Wt.prototype,"floating");Hn([d({type:String,reflect:!0})],Wt.prototype,"layout");const ge=class ge extends S{render(){return m`
  ...
  `;let ut=ai;Jt([d({type:String,reflect:!0})],ut.prototype,"img");Jt([d({type:Boolean,attribute:"label-hidden",reflect:!0})],ut.prototype,"labelHidden");Jt([d({type:String,reflect:!0})],ut.prototype,"icon");Jt([d({type:Boolean,attribute:"icon-hidden",reflect:!0})],ut.prototype,"iconHidden");Jt([d({type:Boolean,reflect:!0})],ut.prototype,"vertical");var Yr=Object.defineProperty,Wr=Object.getOwnPropertyDescriptor,M=(i,t,e,s)=>{for(var n=s>1?void 0:s?Wr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Yr(t,e,n),n};const li=class li extends S{constructor(){super(...arguments),this._value=0,this.vertical=!1,this.slider=!1,this._input=kt(),this.onValueChange=new Event("change")}set value(t){this.setValue(t.toString())}get value(){return this._value}onChange(t){t.stopPropagation();const{value:e}=this._input;e&&this.setValue(e.value)}setValue(t){const{value:e}=this._input;let s=t;if(s=s.replace(/[^0-9.-]/g,""),s=s.replace(/(\..*)\./g,"$1"),s.endsWith(".")||(s.lastIndexOf("-")>0&&(s=s[0]+s.substring(1).replace(/-/g,"")),s==="-"||s==="-0"))return;let n=Number(s);Number.isNaN(n)||(n=this.min!==void 0?Math.max(n,this.min):n,n=this.max!==void 0?Math.min(n,this.max):n,this.value!==n&&(this._value=n,e&&(e.value=this.value.toString()),this.requestUpdate(),this.dispatchEvent(this.onValueChange)))}onBlur(){const{value:t}=this._input;t&&Number.isNaN(Number(t.value))&&(t.value=this.value.toString())}onSliderMouseDown(t){document.body.style.cursor="w-resize";const{clientX:e}=t,s=this.value;let n=!1;const r=l=>{var g;n=!0;const{clientX:c}=l,u=this.step??1,h=((g=u.toString().split(".")[1])==null?void 0:g.length)||0,f=1/(this.sensitivity??1),p=(c-e)/f;if(Math.floor(Math.abs(p))!==Math.abs(p))return;const b=s+p*u;this.setValue(b.toFixed(h))},o=()=>{this.slider=!0,this.removeEventListener("blur",o)},a=()=>{document.removeEventListener("mousemove",r),document.body.style.cursor="default",n?n=!1:(this.addEventListener("blur",o),this.slider=!1,requestAnimationFrame(()=>this.focus())),document.removeEventListener("mouseup",a)};document.addEventListener("mousemove",r),document.addEventListener("mouseup",a)}onFocus(t){t.stopPropagation();const e=s=>{s.key==="Escape"&&(this.blur(),window.removeEventListener("keydown",e))};window.addEventListener("keydown",e)}connectedCallback(){super.connectedCallback(),this.min&&this.min>this.value&&(this._value=this.min),this.max&&this.max<this.value&&(this._value=this.max)}focus(){const{value:t}=this._input;t&&t.focus()}render(){const t=m`
  ...
  `;let L=li;M([d({type:String,reflect:!0})],L.prototype,"name",2);M([d({type:String,reflect:!0})],L.prototype,"icon",2);M([d({type:String,reflect:!0})],L.prototype,"label",2);M([d({type:String,reflect:!0})],L.prototype,"pref",2);M([d({type:Number,reflect:!0})],L.prototype,"min",2);M([d({type:Number,reflect:!0})],L.prototype,"value",1);M([d({type:Number,reflect:!0})],L.prototype,"step",2);M([d({type:Number,reflect:!0})],L.prototype,"sensitivity",2);M([d({type:Number,reflect:!0})],L.prototype,"max",2);M([d({type:String,reflect:!0})],L.prototype,"suffix",2);M([d({type:Boolean,reflect:!0})],L.prototype,"vertical",2);M([d({type:Boolean,reflect:!0})],L.prototype,"slider",2);var Qr=Object.defineProperty,Ur=Object.getOwnPropertyDescriptor,Zt=(i,t,e,s)=>{for(var n=s>1?void 0:s?Ur(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Qr(t,e,n),n};const ci=class ci extends S{constructor(){super(...arguments),this.onValueChange=new Event("change"),this._hidden=!1,this.headerHidden=!1,this.valueTransform={},this.activationButton=document.createElement("bim-button")}set hidden(t){this._hidden=t,this.activationButton.active=!t,this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}get value(){return he(this,this.valueTransform)}set value(t){const e=[...this.children];for(const s in t){const n=e.find(o=>{const a=o;return a.name===s||a.label===s});if(!n)continue;const r=n;r.value=t[s]}}connectedCallback(){super.connectedCallback(),this.activationButton.active=!this.hidden,this.activationButton.onclick=()=>{this.hidden=!this.hidden,this.style.setProperty("animation",`${this.hidden?"closePanel":"openPanel"} 0.4s cubic-bezier(0.65, 0.05, 0.36, 1) forwards`)}}disconnectedCallback(){super.disconnectedCallback(),this.activationButton.remove()}collapseSections(){const t=this.querySelectorAll("bim-panel-section");for(const e of t)e.collapsed=!0}expandSections(){const t=this.querySelectorAll("bim-panel-section");for(const e of t)e.collapsed=!1}render(){return this.activationButton.icon=this.icon,this.activationButton.label=this.label||this.name,this.activationButton.tooltipTitle=this.label||this.name,m`
      <div class="parent">
  ...
  `;let ht=di;ee([d({type:String,reflect:!0})],ht.prototype,"name");ee([d({type:String,reflect:!0})],ht.prototype,"icon");ee([d({type:String,reflect:!0})],ht.prototype,"label");ee([d({type:Boolean,reflect:!0})],ht.prototype,"vertical");ee([Lt()],ht.prototype,"_value");const Kr=()=>m`
    <style>
      div {
        display: flex;
        gap: 0.375rem;
  ...
  `;var Zr=Object.defineProperty,to=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Zr(t,e,n),n};const hi=class hi extends S{constructor(){super(...arguments),this.column="",this.columnIndex=0,this.rowData={}}get data(){return this.column?this.rowData[this.column]:null}render(){return m`
      <style>
        :host {
  ...
  `;let fe=hi;to([d({type:String,reflect:!0})],fe.prototype,"column");var eo=Object.defineProperty,io=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&eo(t,e,n),n};const fi=class fi extends S{constructor(){super(...arguments),this._groups=[],this.data=[],this.table=this.closest("bim-table")}toggleGroups(t,e=!1){for(const s of this._groups)s.childrenHidden=typeof t>"u"?!s.childrenHidden:!t,e&&s.toggleChildren(t,e)}render(){return this._groups=[],m`
      <slot></slot>
  ...
  `;let pe=fi;io([d({type:Array,attribute:!1})],pe.prototype,"data");var no=Object.defineProperty,so=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&no(t,e,n),n};const pi=class pi extends S{constructor(){super(...arguments),this.data={data:{}},this.childrenHidden=!0,this.table=this.closest("bim-table")}connectedCallback(){super.connectedCallback(),this.table&&this.table.expanded?this.childrenHidden=!1:this.childrenHidden=!0}toggleChildren(t,e=!1){this._children&&(this.childrenHidden=typeof t>"u"?!this.childrenHidden:!t,e&&this._children.toggleGroups(t,e),this.animateTableChildren(!0))}animateTableChildren(t=!0){if(!t){requestAnimationFrame(()=>{var r;const e=this.renderRoot.querySelector(".caret"),s=this.renderRoot.querySelector(".branch-vertical"),n=(r=this.renderRoot.querySelector("bim-table-children"))==null?void 0:r.querySelector(".branch-vertical");e.style.setProperty("transform",`translateY(-50%) rotate(${this.childrenHidden?"0":"90"}deg)`),s.style.setProperty("transform",`scaleY(${this.childrenHidden?"0":"1"})`),n==null||n.style.setProperty("transform",`scaleY(${this.childrenHidden?"0":"1"})`)});return}requestAnimationFrame(()=>{var h;const e=this.renderRoot.querySelector("bim-table-children"),s=this.renderRoot.querySelector(".caret"),n=this.renderRoot.querySelector(".branch-vertical"),r=(h=this.renderRoot.querySelector("bim-table-children"))==null?void 0:h.querySelector(".branch-vertical"),o=()=>{const f=e==null?void 0:e.renderRoot.querySelectorAll("bim-table-group");f==null||f.forEach((p,b)=>{p.style.setProperty("opacity","0"),p.style.setProperty("left","-30px");const g=[{opacity:"0",left:"-30px"},{opacity:"1",left:"0"}];p.animate(g,{duration:300,delay:50+b*50,easing:"cubic-bezier(0.65, 0.05, 0.36, 1)",fill:"forwards"})})},a=(f=!1)=>{const p=[{transform:"translateY(-50%) rotate(90deg)"},{transform:"translateY(-50%) rotate(0deg)"}];s==null||s.animate(p,{duration:500,easing:"cubic-bezier(0.68, -0.55, 0.27, 1.55)",fill:"forwards",direction:f?"normal":"reverse"})},l=(f=!1)=>{const p=[{transform:"scaleY(1)"},{transform:"scaleY(0)"}];n==null||n.animate(p,{duration:250,easing:"cubic-bezier(0.4, 0, 0.2, 1)",delay:f?0:200,fill:"forwards",direction:f?"normal":"reverse"})},c=(f=!1)=>{var b;const p=(b=this.renderRoot.querySelector("bim-table-row"))==null?void 0:b.querySelector(".branch-horizontal");if(p){p.style.setProperty("transform-origin","center right");const g=[{transform:"scaleX(0)"},{transform:"scaleX(1)"}];p.animate(g,{duration:250,easing:"cubic-bezier(0.4, 0, 0.2, 1)",fill:"forwards",direction:f?"normal":"reverse"})}},u=()=>{const f=[{transform:"scaleY(0)"},{transform:"scaleY(1)"}];r==null||r.animate(f,{duration:300,easing:"cubic-bezier(0.4, 0, 0.2, 1)",fill:"forwards",delay:300})};o(),a(this.childrenHidden),l(this.childrenHidden),c(this.childrenHidden),u()})}firstUpdated(){this.renderRoot.querySelectorAll(".caret").forEach(e=>{var s,n,r;if(!this.childrenHidden){e.style.setProperty("transform","translateY(-50%) rotate(90deg)");const a=(s=e.parentElement)==null?void 0:s.querySelector(".branch-horizontal");a&&a.style.setProperty("transform","scaleX(0)");const l=(r=(n=e.parentElement)==null?void 0:n.parentElement)==null?void 0:r.querySelectorAll(".branch-vertical");l==null||l.forEach(c=>{c.style.setProperty("transform","scaleY(1)")})}})}render(){if(!this.table)throw new Error("TableGroup: parent table wasn't found!");const t=this.table.getGroupIndentation(this.data)??0,e=m`
  ...
  `;let me=pi;so([d({type:Boolean,attribute:"children-hidden",reflect:!0})],me.prototype,"childrenHidden");var ro=Object.defineProperty,Rt=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&ro(t,e,n),n};const mi=class mi extends S{constructor(){super(...arguments),this.selected=!1,this.columns=[],this.hiddenColumns=[],this.data={},this.isHeader=!1,this.table=this.closest("bim-table"),this.onTableColumnsChange=()=>{this.table&&(this.columns=this.table.columns)},this.onTableColumnsHidden=()=>{this.table&&(this.hiddenColumns=this.table.hiddenColumns)},this._observer=new IntersectionObserver(()=>{},{rootMargin:"36px"})}get _columnNames(){return this.columns.filter(s=>!this.hiddenColumns.includes(s.name)).map(s=>s.name)}get _columnWidths(){return this.columns.filter(s=>!this.hiddenColumns.includes(s.name)).map(s=>s.width)}get _isSelected(){var t;return(t=this.table)==null?void 0:t.selection.has(this.data)}onSelectionChange(t){if(!this.table)return;const e=t.target;this.selected=e.value,e.value?(this.table.selection.add(this.data),this.table.dispatchEvent(new CustomEvent("rowselected",{detail:{data:this.data}}))):(this.table.selection.delete(this.data),this.table.dispatchEvent(new CustomEvent("rowdeselected",{detail:{data:this.data}})))}connectedCallback(){super.connectedCallback(),this._observer.observe(this),this.table&&(this.columns=this.table.columns,this.hiddenColumns=this.table.hiddenColumns,this.table.addEventListener("columnschange",this.onTableColumnsChange),this.table.addEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",this._isSelected))}disconnectedCallback(){super.disconnectedCallback(),this._observer.unobserve(this),this.table&&(this.columns=[],this.hiddenColumns=[],this.table.removeEventListener("columnschange",this.onTableColumnsChange),this.table.removeEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",!1))}compute(){if(!this.table)throw new Error("TableRow: parent table wasn't found!");const t=this.table.getRowIndentation(this.data)??0,e=this.isHeader?this.data:this.table.applyDataTransform(this.data)??this.data,s=[];for(const n in e){if(this.hiddenColumns.includes(n))continue;const r=e[n];let o;if(typeof r=="string"||typeof r=="boolean"||typeof r=="number"?(o=document.createElement("bim-label"),o.textContent=String(r)):r instanceof HTMLElement?o=r:(o=document.createDocumentFragment(),Ht(r,o)),!o)continue;const a=document.createElement("bim-table-cell");a.append(o),a.column=n,this._columnNames.indexOf(n)===0&&(a.style.marginLeft=`${this.table.noIndentation?0:t+.75}rem`);const l=this._columnNames.indexOf(n);a.setAttribute("data-column-index",String(l)),a.toggleAttribute("data-no-indentation",l===0&&this.table.noIndentation),a.toggleAttribute("data-cell-header",this.isHeader),a.rowData=this.data,this.table.dispatchEvent(new CustomEvent("cellcreated",{detail:{cell:a}})),s.push(a)}return this.style.gridTemplateAreas=`"${this.table.selectableRows?"Selection":""} ${this._columnNames.join(" ")}"`,this.style.gridTemplateColumns=`${this.table.selectableRows?"1.6rem":""} ${this._columnWidths.join(" ")}`,m`
      ...
      ${s}
      <slot></slot>
    `}render(){return m`${this.compute()}`}};mi.styles=C`
    :host {
      position: relative;
      grid-area: Data;
      display: grid;
 ...
 */const Gi=i=>i??Wn;var fo=Object.defineProperty,po=Object.getOwnPropertyDescriptor,et=(i,t,e,s)=>{for(var n=s>1?void 0:s?po(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&fo(t,e,n),n};const yi=class yi extends S{constructor(){super(...arguments),this._inputTypes=["date","datetime-local","email","month","password","search","tel","text","time","url","week","area"],this.value="",this.vertical=!1,this._type="text",this.onValueChange=new Event("input")}set type(t){this._inputTypes.includes(t)&&(this._type=t)}get type(){return this._type}get query(){return qe(this.value)}onInputChange(t){t.stopPropagation();const e=t.target;clearTimeout(this._debounceTimeoutID),this._debounceTimeoutID=setTimeout(()=>{this.value=e.value,this.dispatchEvent(this.onValueChange)},this.debounce)}focus(){setTimeout(()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()})}render(){return m`
  ...
  `;let It=_i;ti([d({type:String,reflect:!0})],It.prototype,"icon",2);ti([d({type:Boolean,attribute:"labels-hidden",reflect:!0})],It.prototype,"labelsHidden",2);ti([d({type:Boolean,reflect:!0})],It.prototype,"vertical",1);var wo=Object.defineProperty,_o=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&wo(t,e,n),n};const Ci=class Ci extends S{constructor(){super(),this._onResize=new Event("resize"),new ResizeObserver(()=>{setTimeout(()=>{this.dispatchEvent(this._onResize)})}).observe(this)}render(){return m`
      <div class="parent">
        <slot></slot>
      </div>
    `}};Ci.styles=C`
