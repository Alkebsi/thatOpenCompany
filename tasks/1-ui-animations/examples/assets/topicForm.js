import"./modulepreload-polyfill-B5Qt9EMX.js";import{n as z,x as s,T as g,a0 as B,m as r,a1 as M,k as N,C as U}from"./index-BnDhwfId.js";import"./lit-html-CuBe1DX_.js";import{e as C}from"./ref-DfidMTJ6.js";const E={dueDate:t=>{if(typeof t=="string"&&t.trim()!=="")return new Date(t)},status:t=>{if(Array.isArray(t)&&t.length!==0)return t[0]},type:t=>{if(Array.isArray(t)&&t.length!==0)return t[0]},priority:t=>{if(Array.isArray(t)&&t.length!==0)return t[0]},stage:t=>{if(Array.isArray(t)&&t.length!==0)return t[0]},assignedTo:t=>{if(Array.isArray(t)&&t.length!==0)return t[0]},labels:t=>{if(Array.isArray(t))return new Set(t)}},G=t=>{const{components:$,topic:e,value:n,onCancel:I,onSubmit:_,styles:d}=t,w=_??(()=>{}),a=$.get(z),j=(n==null?void 0:n.title)??(e==null?void 0:e.title)??s.default.title,m=(n==null?void 0:n.status)??(e==null?void 0:e.status)??s.default.status,p=(n==null?void 0:n.type)??(e==null?void 0:e.type)??s.default.type,b=(n==null?void 0:n.priority)??(e==null?void 0:e.priority)??s.default.priority,u=(n==null?void 0:n.assignedTo)??(e==null?void 0:e.assignedTo)??s.default.assignedTo,c=(n==null?void 0:n.labels)??(e==null?void 0:e.labels)??s.default.labels,f=(n==null?void 0:n.stage)??(e==null?void 0:e.stage)??s.default.stage,L=(n==null?void 0:n.description)??(e==null?void 0:e.description)??s.default.description,O=e!=null&&e.dueDate?e.dueDate.toISOString().split("T")[0]:null,T=new Set([...a.config.statuses]);m&&T.add(m);const x=new Set([...a.config.types]);p&&x.add(p);const S=new Set([...a.config.priorities]);b&&S.add(b);const h=new Set([...a.config.users]);u&&h.add(u);const A=new Set([...a.config.labels]);if(c)for(const i of c)A.add(i);const D=new Set([...a.config.stages]);f&&D.add(f);const k=C(),R=async()=>{const{value:i}=k;if(!i)return;const o=M(i,E);if(e)e.set(o),await w(e);else{const l=a.create(o);await w(l)}},v=C(),q=i=>{const{value:o}=v;if(!o)return;const l=i.target;o.disabled=l.value.trim()===""},F=`btn-${g.newRandomId()}`,y=`btn-${g.newRandomId()}`;return r`
    <div ${B(k)} style="display: flex; flex-direction: column; gap: 0.75rem;">
      ...
      <div style="justify-content: right; display: flex; gap: 0.375rem">
        ...
        <bim-button id=${F} style="flex: 0" @click=${R} ${B(v)} label=${e?"Update Topic":"Add Topic"} icon=${e?"tabler:refresh":"mi:add"}></bim-button>
      </div>
    </div>
  `},H=t=>r`
